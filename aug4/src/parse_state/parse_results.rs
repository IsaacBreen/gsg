...
pub trait ParseResultTrait {
    ...
    fn new(right_data_vec: Vec<RightData>, done: bool) -> Self where Self: Sized;
...
impl ParseResultTrait for ParseResults {
    ...
    fn new(right_data_vec: Vec<RightData>, done: bool) -> Self {
        ParseResults {
            right_data_vec,
            done,
        }
