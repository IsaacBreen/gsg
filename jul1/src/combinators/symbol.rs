use std::any::Any;
use std::rc::Rc;
use crate::{Choice2, CombinatorTrait, EatU8, Eps, IndentCombinator, IntoCombinator, ParseResults, ParserTrait, PreventConsecutiveMatchesClear, Repeat1, RightData, Seq2, Stats, UpData};
