// use std::any::Any;
// use std::rc::Rc;
// use crate::{Choice, CombinatorTrait, EatU8, Eps, IndentCombinator, IntoCombinator, ParseResults, ParserTrait, ForbidFollowsClear, Repeat1, RightData, Seq, Stats, UpData};
//
// pub struct Symbol<T> {
//     pub value: Rc<T>,
// }
