...
fn expression_without_invalid() -> Combinator {
    tag("expression_without_invalid", crate::profile("expression_without_invalid", choice!(
...
fn func_type_comment() -> Combinator {
    tag("func_type_comment", crate::profile("func_type_comment", choice!(
...
fn type_expressions() -> Combinator {
    tag("type_expressions", crate::profile("type_expressions", choice!(
...
fn del_t_atom() -> Combinator {
    tag("del_t_atom", crate::profile("del_t_atom", choice!(
        &NAME,
...
fn del_target() -> Combinator {
    cached(tag("del_target", crate::profile("del_target", choice!(
...
fn del_targets() -> Combinator {
    tag("del_targets", crate::profile("del_targets", seq!(&del_target, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &del_target, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &del_target))))), opt(seq!(opt(&WS), python_literal(",")))))).into()
}

fn t_lookahead() -> Combinator {
    tag("t_lookahead", crate::profile("t_lookahead", choice!(
        python_literal("("),
        python_literal("["),
        python_literal(".")
    ))).into()
...
fn star_atom() -> Combinator {
    tag("star_atom", crate::profile("star_atom", choice!(
        &NAME,
...
fn target_with_star_atom() -> Combinator {
    cached(tag("target_with_star_atom", crate::profile("target_with_star_atom", choice!(
...
fn star_target() -> Combinator {
    cached(tag("star_target", crate::profile("star_target", choice!(
...
fn star_targets_tuple_seq() -> Combinator {
    tag("star_targets_tuple_seq", crate::profile("star_targets_tuple_seq", seq!(&star_target, opt(&WS), python_literal(","), opt(seq!(opt(&WS), &star_target, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target))), opt(seq!(opt(&WS), python_literal(",")))))))).into()
}

fn star_targets_list_seq() -> Combinator {
    tag("star_targets_list_seq", crate::profile("star_targets_list_seq", seq!(&star_target, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target))))), opt(seq!(opt(&WS), python_literal(",")))))).into()
}

fn star_targets() -> Combinator {
    tag("star_targets", crate::profile("star_targets", seq!(&star_target, choice!(negative_lookahead(seq!(opt(&WS), python_literal(","))), seq!(opt(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target))))), opt(seq!(opt(&WS), python_literal(",")))))))).into()
}

fn kwarg_or_double_starred() -> Combinator {
    tag("kwarg_or_double_starred", crate::profile("kwarg_or_double_starred", choice!(
...
fn kwarg_or_starred() -> Combinator {
    tag("kwarg_or_starred", crate::profile("kwarg_or_starred", choice!(
        seq!(&NAME, opt(&WS), python_literal("="), opt(&WS), &expression),
        seq!(python_literal("*"), opt(&WS), &expression)
    ))).into()
}
...
fn starred_expression() -> Combinator {
    tag("starred_expression", crate::profile("starred_expression", seq!(python_literal("*"), opt(&WS), &expression))).into()
}

fn kwargs() -> Combinator {
    tag("kwargs", crate::profile("kwargs", choice!(
...
fn args() -> Combinator {
    tag("args", crate::profile("args", choice!(
...
fn arguments() -> Combinator {
    cached(tag("arguments", crate::profile("arguments", seq!(&args, opt(seq!(opt(&WS), python_literal(","))), lookahead(seq!(opt(&WS), python_literal(")"))))))).into()
}

fn dictcomp() -> Combinator {
    tag("dictcomp", crate::profile("dictcomp", seq!(
        python_literal("{"),
         opt(&WS),
         &kvpair,
         opt(&WS),
...
fn genexp() -> Combinator {
    tag("genexp", crate::profile("genexp", seq!(
        python_literal("("),
         opt(&WS),
...
fn setcomp() -> Combinator {
    tag("setcomp", crate::profile("setcomp", seq!(
        python_literal("{"),
         opt(&WS),
         &named_expression,
         opt(&WS),
...
fn listcomp() -> Combinator {
    tag("listcomp", crate::profile("listcomp", seq!(
        python_literal("["),
         opt(&WS),
         &named_expression,
         opt(&WS),
...
fn for_if_clause() -> Combinator {
    tag("for_if_clause", crate::profile("for_if_clause", choice!(
...
fn for_if_clauses() -> Combinator {
    tag("for_if_clauses", crate::profile("for_if_clauses", seq!(&for_if_clause, opt(repeat1(seq!(opt(&WS), &for_if_clause)))))).into()
}

fn kvpair() -> Combinator {
    tag("kvpair", crate::profile("kvpair", seq!(
...
fn double_starred_kvpair() -> Combinator {
    tag("double_starred_kvpair", crate::profile("double_starred_kvpair", choice!(
...
fn double_starred_kvpairs() -> Combinator {
    tag("double_starred_kvpairs", crate::profile("double_starred_kvpairs", seq!(&double_starred_kvpair, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &double_starred_kvpair, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &double_starred_kvpair))))), opt(seq!(opt(&WS), python_literal(",")))))).into()
}

fn dict() -> Combinator {
    tag("dict", crate::profile("dict", seq!(python_literal("{"), opt(seq!(opt(&WS), &double_starred_kvpairs)), opt(&WS), python_literal("}")))).into()
}

fn set() -> Combinator {
    tag("set", crate::profile("set", seq!(
        python_literal("{"),
         opt(&WS),
...
fn tuple() -> Combinator {
    tag("tuple", crate::profile("tuple", seq!(python_literal("("), opt(seq!(opt(&WS), &star_named_expression, opt(&WS), python_literal(","), opt(seq!(opt(&WS), &star_named_expressions)))), opt(&WS), python_literal(")")))).into()
}

fn list() -> Combinator {
    tag("list", crate::profile("list", seq!(python_literal("["), opt(seq!(opt(&WS), &star_named_expressions)), opt(&WS), python_literal("]")))).into()
}

fn strings() -> Combinator {
    cached(tag("strings", crate::profile("strings", seq!(choice!(seq!(&FSTRING_START, opt(seq!(opt(&WS), &fstring_middle, opt(repeat1(seq!(opt(&WS), &fstring_middle))))), opt(&WS), &FSTRING_END), &STRING), opt(repeat1(seq!(opt(&WS), choice!(seq!(&FSTRING_START, opt(seq!(opt(&WS), &fstring_middle, opt(repeat1(seq!(opt(&WS), &fstring_middle))))), opt(&WS), &FSTRING_END), &STRING)))))))).into()
}

fn string() -> Combinator {
    tag("string", crate::profile("string", &STRING)).into()
}

fn fstring() -> Combinator {
    tag("fstring", crate::profile("fstring", seq!(&FSTRING_START, opt(seq!(opt(&WS), &fstring_middle, opt(repeat1(seq!(opt(&WS), &fstring_middle))))), opt(&WS), &FSTRING_END))).into()
}

fn fstring_format_spec() -> Combinator {
    tag("fstring_format_spec", crate::profile("fstring_format_spec", choice!(
        &FSTRING_MIDDLE,
...
fn fstring_full_format_spec() -> Combinator {
    tag("fstring_full_format_spec", crate::profile("fstring_full_format_spec", seq!(python_literal(":"), opt(seq!(opt(&WS), &fstring_format_spec, opt(repeat1(seq!(opt(&WS), &fstring_format_spec)))))))).into()
}

fn fstring_conversion() -> Combinator {
    tag("fstring_conversion", crate::profile("fstring_conversion", seq!(python_literal("!"), opt(&WS), &NAME))).into()
}

fn fstring_replacement_field() -> Combinator {
    tag("fstring_replacement_field", crate::profile("fstring_replacement_field", seq!(
        python_literal("{"),
         opt(&WS),
         &annotated_rhs,
...
fn fstring_middle() -> Combinator {
    tag("fstring_middle", crate::profile("fstring_middle", choice!(
...
fn lambda_param() -> Combinator {
    tag("lambda_param", crate::profile("lambda_param", &NAME)).into()
}

fn lambda_param_maybe_default() -> Combinator {
    tag("lambda_param_maybe_default", crate::profile("lambda_param_maybe_default", seq!(&lambda_param, opt(seq!(opt(&WS), &default)), choice!(seq!(opt(&WS), python_literal(",")), lookahead(seq!(opt(&WS), python_literal(":"))))))).into()
}

fn lambda_param_with_default() -> Combinator {
    tag("lambda_param_with_default", crate::profile("lambda_param_with_default", seq!(&lambda_param, opt(&WS), &default, choice!(seq!(opt(&WS), python_literal(",")), lookahead(seq!(opt(&WS), python_literal(":"))))))).into()
}

fn lambda_param_no_default() -> Combinator {
    tag("lambda_param_no_default", crate::profile("lambda_param_no_default", seq!(&lambda_param, choice!(seq!(opt(&WS), python_literal(",")), lookahead(seq!(opt(&WS), python_literal(":"))))))).into()
}

fn lambda_kwds() -> Combinator {
    tag("lambda_kwds", crate::profile("lambda_kwds", seq!(python_literal("**"), opt(&WS), &lambda_param_no_default))).into()
}

fn lambda_star_etc() -> Combinator {
    tag("lambda_star_etc", crate::profile("lambda_star_etc", choice!(
...
fn lambda_slash_with_default() -> Combinator {
    tag("lambda_slash_with_default", crate::profile("lambda_slash_with_default", seq!(
...
fn lambda_slash_no_default() -> Combinator {
    tag("lambda_slash_no_default", crate::profile("lambda_slash_no_default", seq!(
...
fn lambda_parameters() -> Combinator {
    tag("lambda_parameters", crate::profile("lambda_parameters", choice!(
...
fn lambda_params() -> Combinator {
    tag("lambda_params", crate::profile("lambda_params", &lambda_parameters)).into()
}

fn lambdef() -> Combinator {
    tag("lambdef", crate::profile("lambdef", seq!(
...
fn group() -> Combinator {
    tag("group", crate::profile("group", seq!(
        python_literal("("),
         opt(&WS),
...
fn atom() -> Combinator {
    tag("atom", crate::profile("atom", choice!(
        &NAME,
        python_literal("True"),
...
fn slice() -> Combinator {
    tag("slice", crate::profile("slice", choice!(
...
fn slices() -> Combinator {
    tag("slices", crate::profile("slices", choice!(
...
fn primary() -> Combinator {
    tag("primary", crate::profile("primary", seq!(&atom, opt(seq!(opt(&WS), choice!(seq!(python_literal("."), opt(&WS), &NAME), &genexp, seq!(python_literal("("), opt(seq!(opt(&WS), &arguments)), opt(&WS), python_literal(")")), seq!(python_literal("["), opt(&WS), &slices, opt(&WS), python_literal("]"))), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("."), opt(&WS), &NAME), &genexp, seq!(python_literal("("), opt(seq!(opt(&WS), &arguments)), opt(&WS), python_literal(")")), seq!(python_literal("["), opt(&WS), &slices, opt(&WS), python_literal("]"))))))))))).into()
}

fn await_primary() -> Combinator {
    cached(tag("await_primary", crate::profile("await_primary", choice!(
...
fn power() -> Combinator {
    tag("power", crate::profile("power", seq!(&await_primary, opt(seq!(opt(&WS), python_literal("**"), opt(&WS), &factor))))).into()
}

fn factor() -> Combinator {
    cached(tag("factor", crate::profile("factor", choice!(
...
fn term() -> Combinator {
    tag("term", crate::profile("term", seq!(&factor, opt(seq!(opt(&WS), choice!(seq!(python_literal("*"), opt(&WS), &factor), seq!(python_literal("/"), opt(&WS), &factor), seq!(python_literal("//"), opt(&WS), &factor), seq!(python_literal("%"), opt(&WS), &factor), seq!(python_literal("@"), opt(&WS), &factor)), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("*"), opt(&WS), &factor), seq!(python_literal("/"), opt(&WS), &factor), seq!(python_literal("//"), opt(&WS), &factor), seq!(python_literal("%"), opt(&WS), &factor), seq!(python_literal("@"), opt(&WS), &factor)))))))))).into()
}

fn sum() -> Combinator {
    tag("sum", crate::profile("sum", seq!(&term, opt(seq!(opt(&WS), choice!(seq!(python_literal("+"), opt(&WS), &term), seq!(python_literal("-"), opt(&WS), &term)), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("+"), opt(&WS), &term), seq!(python_literal("-"), opt(&WS), &term)))))))))).into()
}

fn shift_expr() -> Combinator {
    tag("shift_expr", crate::profile("shift_expr", seq!(&sum, opt(seq!(opt(&WS), choice!(seq!(python_literal("<<"), opt(&WS), &sum), seq!(python_literal(">>"), opt(&WS), &sum)), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("<<"), opt(&WS), &sum), seq!(python_literal(">>"), opt(&WS), &sum)))))))))).into()
}

fn bitwise_and() -> Combinator {
    tag("bitwise_and", crate::profile("bitwise_and", seq!(&shift_expr, opt(seq!(opt(&WS), python_literal("&"), opt(&WS), &shift_expr, opt(repeat1(seq!(opt(&WS), python_literal("&"), opt(&WS), &shift_expr)))))))).into()
}

fn bitwise_xor() -> Combinator {
    tag("bitwise_xor", crate::profile("bitwise_xor", seq!(&bitwise_and, opt(seq!(opt(&WS), python_literal("^"), opt(&WS), &bitwise_and, opt(repeat1(seq!(opt(&WS), python_literal("^"), opt(&WS), &bitwise_and)))))))).into()
}

fn bitwise_or() -> Combinator {
    tag("bitwise_or", crate::profile("bitwise_or", seq!(&bitwise_xor, opt(seq!(opt(&WS), python_literal("|"), opt(&WS), &bitwise_xor, opt(repeat1(seq!(opt(&WS), python_literal("|"), opt(&WS), &bitwise_xor)))))))).into()
}

fn is_bitwise_or() -> Combinator {
    tag("is_bitwise_or", crate::profile("is_bitwise_or", seq!(python_literal("is"), opt(&WS), &bitwise_or))).into()
}

fn isnot_bitwise_or() -> Combinator {
    tag("isnot_bitwise_or", crate::profile("isnot_bitwise_or", seq!(
        python_literal("is"),
         opt(&WS),
         python_literal("not"),
         opt(&WS),
...
fn in_bitwise_or() -> Combinator {
    tag("in_bitwise_or", crate::profile("in_bitwise_or", seq!(python_literal("in"), opt(&WS), &bitwise_or))).into()
}

fn notin_bitwise_or() -> Combinator {
    tag("notin_bitwise_or", crate::profile("notin_bitwise_or", seq!(
        python_literal("not"),
         opt(&WS),
         python_literal("in"),
         opt(&WS),
...
fn gt_bitwise_or() -> Combinator {
    tag("gt_bitwise_or", crate::profile("gt_bitwise_or", seq!(python_literal(">"), opt(&WS), &bitwise_or))).into()
}

fn gte_bitwise_or() -> Combinator {
    tag("gte_bitwise_or", crate::profile("gte_bitwise_or", seq!(python_literal(">="), opt(&WS), &bitwise_or))).into()
}

fn lt_bitwise_or() -> Combinator {
    tag("lt_bitwise_or", crate::profile("lt_bitwise_or", seq!(python_literal("<"), opt(&WS), &bitwise_or))).into()
}

fn lte_bitwise_or() -> Combinator {
    tag("lte_bitwise_or", crate::profile("lte_bitwise_or", seq!(python_literal("<="), opt(&WS), &bitwise_or))).into()
}

fn noteq_bitwise_or() -> Combinator {
    tag("noteq_bitwise_or", crate::profile("noteq_bitwise_or", seq!(python_literal("!="), opt(&WS), &bitwise_or))).into()
}

fn eq_bitwise_or() -> Combinator {
    tag("eq_bitwise_or", crate::profile("eq_bitwise_or", seq!(python_literal("=="), opt(&WS), &bitwise_or))).into()
}

fn compare_op_bitwise_or_pair() -> Combinator {
    tag("compare_op_bitwise_or_pair", crate::profile("compare_op_bitwise_or_pair", choice!(
        &eq_bitwise_or,
        &noteq_bitwise_or,
        &lte_bitwise_or,
        &lt_bitwise_or,
...
fn comparison() -> Combinator {
    tag("comparison", crate::profile("comparison", seq!(&bitwise_or, opt(seq!(opt(&WS), &compare_op_bitwise_or_pair, opt(repeat1(seq!(opt(&WS), &compare_op_bitwise_or_pair)))))))).into()
}

fn inversion() -> Combinator {
    cached(tag("inversion", crate::profile("inversion", choice!(
...
fn conjunction() -> Combinator {
    cached(tag("conjunction", crate::profile("conjunction", seq!(&inversion, opt(seq!(opt(&WS), python_literal("and"), opt(&WS), &inversion, opt(repeat1(seq!(opt(&WS), python_literal("and"), opt(&WS), &inversion))))))))).into()
}

fn disjunction() -> Combinator {
    cached(tag("disjunction", crate::profile("disjunction", seq!(&conjunction, opt(seq!(opt(&WS), python_literal("or"), opt(&WS), &conjunction, opt(repeat1(seq!(opt(&WS), python_literal("or"), opt(&WS), &conjunction))))))))).into()
}

fn named_expression() -> Combinator {
    tag("named_expression", crate::profile("named_expression", choice!(
        seq!(&NAME, opt(&WS), python_literal(":="), opt(&WS), &expression),
...
fn assignment_expression() -> Combinator {
    tag("assignment_expression", crate::profile("assignment_expression", seq!(
        &NAME,
         opt(&WS),
         python_literal(":="),
         opt(&WS),
...
fn star_named_expression() -> Combinator {
    tag("star_named_expression", crate::profile("star_named_expression", choice!(
        seq!(python_literal("*"), opt(&WS), &bitwise_or),
        &named_expression
    ))).into()
}
...
fn star_named_expressions() -> Combinator {
    tag("star_named_expressions", crate::profile("star_named_expressions", seq!(&star_named_expression, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &star_named_expression, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_named_expression))))), opt(seq!(opt(&WS), python_literal(",")))))).into()
}

fn star_expression() -> Combinator {
    cached(tag("star_expression", crate::profile("star_expression", choice!(
        seq!(python_literal("*"), opt(&WS), &bitwise_or),
        choice!(seq!(&disjunction, opt(seq!(opt(&WS), python_literal("if"), opt(&WS), &disjunction, opt(&WS), python_literal("else"), opt(&WS), &expression))), &lambdef)
    )))).into()
}
...
fn star_expressions() -> Combinator {
    tag("star_expressions", crate::profile("star_expressions", seq!(&star_expression, opt(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &star_expression, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_expression))), opt(seq!(opt(&WS), python_literal(",")))))))))).into()
}

fn yield_expr() -> Combinator {
    tag("yield_expr", crate::profile("yield_expr", seq!(python_literal("yield"), choice!(seq!(opt(&WS), python_literal("from"), opt(&WS), &expression), opt(seq!(opt(&WS), &star_expressions)))))).into()
}

fn expression() -> Combinator {
    cached(tag("expression", crate::profile("expression", choice!(
...
fn expressions() -> Combinator {
    tag("expressions", crate::profile("expressions", seq!(&expression, opt(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &expression, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &expression))), opt(seq!(opt(&WS), python_literal(",")))))))))).into()
}

fn type_param_starred_default() -> Combinator {
    tag("type_param_starred_default", crate::profile("type_param_starred_default", seq!(python_literal("="), opt(&WS), &star_expression))).into()
}

fn type_param_default() -> Combinator {
    tag("type_param_default", crate::profile("type_param_default", seq!(python_literal("="), opt(&WS), &expression))).into()
}

fn type_param_bound() -> Combinator {
    tag("type_param_bound", crate::profile("type_param_bound", seq!(python_literal(":"), opt(&WS), &expression))).into()
}

fn type_param() -> Combinator {
    cached(tag("type_param", crate::profile("type_param", choice!(
...
fn type_param_seq() -> Combinator {
    tag("type_param_seq", crate::profile("type_param_seq", seq!(&type_param, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &type_param, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &type_param))))), opt(seq!(opt(&WS), python_literal(",")))))).into()
}

fn type_params() -> Combinator {
    tag("type_params", crate::profile("type_params", seq!(
        python_literal("["),
         opt(&WS),
         &type_param_seq,
         opt(&WS),
...
fn type_alias() -> Combinator {
    tag("type_alias", crate::profile("type_alias", seq!(
        python_literal("type"),
         opt(&WS),
         &NAME,
...
fn keyword_pattern() -> Combinator {
    tag("keyword_pattern", crate::profile("keyword_pattern", seq!(
        &NAME,
         opt(&WS),
         python_literal("="),
         opt(&WS),
...
fn keyword_patterns() -> Combinator {
    tag("keyword_patterns", crate::profile("keyword_patterns", seq!(&keyword_pattern, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &keyword_pattern, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &keyword_pattern)))))))).into()
}

fn positional_patterns() -> Combinator {
    tag("positional_patterns", crate::profile("positional_patterns", seq!(choice!(&as_pattern, &or_pattern), opt(seq!(opt(&WS), python_literal(","), opt(&WS), &pattern, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &pattern)))))))).into()
}

fn class_pattern() -> Combinator {
    tag("class_pattern", crate::profile("class_pattern", seq!(
        &NAME,
...
fn double_star_pattern() -> Combinator {
    tag("double_star_pattern", crate::profile("double_star_pattern", seq!(python_literal("**"), opt(&WS), &pattern_capture_target))).into()
}

fn key_value_pattern() -> Combinator {
    tag("key_value_pattern", crate::profile("key_value_pattern", seq!(
...
fn items_pattern() -> Combinator {
    tag("items_pattern", crate::profile("items_pattern", seq!(&key_value_pattern, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &key_value_pattern, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &key_value_pattern)))))))).into()
}

fn mapping_pattern() -> Combinator {
    tag("mapping_pattern", crate::profile("mapping_pattern", seq!(python_literal("{"), opt(&WS), choice!(python_literal("}"), seq!(&double_star_pattern, opt(seq!(opt(&WS), python_literal(","))), opt(&WS), python_literal("}")), seq!(&items_pattern, opt(&WS), choice!(seq!(python_literal(","), opt(&WS), &double_star_pattern, opt(seq!(opt(&WS), python_literal(","))), opt(&WS), python_literal("}")), seq!(opt(seq!(python_literal(","), opt(&WS))), python_literal("}")))))))).into()
}

fn star_pattern() -> Combinator {
    cached(tag("star_pattern", crate::profile("star_pattern", seq!(python_literal("*"), opt(&WS), choice!(&pattern_capture_target, &wildcard_pattern))))).into()
}

fn maybe_star_pattern() -> Combinator {
    tag("maybe_star_pattern", crate::profile("maybe_star_pattern", choice!(
        &star_pattern,
...
fn maybe_sequence_pattern() -> Combinator {
    tag("maybe_sequence_pattern", crate::profile("maybe_sequence_pattern", seq!(&maybe_star_pattern, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &maybe_star_pattern, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &maybe_star_pattern))))), opt(seq!(opt(&WS), python_literal(",")))))).into()
}

fn open_sequence_pattern() -> Combinator {
    tag("open_sequence_pattern", crate::profile("open_sequence_pattern", seq!(&maybe_star_pattern, opt(&WS), python_literal(","), opt(seq!(opt(&WS), &maybe_sequence_pattern))))).into()
}

fn sequence_pattern() -> Combinator {
    tag("sequence_pattern", crate::profile("sequence_pattern", choice!(
...
fn group_pattern() -> Combinator {
    tag("group_pattern", crate::profile("group_pattern", seq!(
        python_literal("("),
         opt(&WS),
         &pattern,
         opt(&WS),
...
fn name_or_attr() -> Combinator {
    tag("name_or_attr", crate::profile("name_or_attr", seq!(&NAME, opt(seq!(opt(&WS), python_literal("."), opt(&WS), &NAME, opt(repeat1(seq!(opt(&WS), python_literal("."), opt(&WS), &NAME)))))))).into()
}

fn attr() -> Combinator {
    tag("attr", crate::profile("attr", seq!(
        &name_or_attr,
         opt(&WS),
         python_literal("."),
         opt(&WS),
...
fn value_pattern() -> Combinator {
    tag("value_pattern", crate::profile("value_pattern", seq!(&attr, negative_lookahead(seq!(opt(&WS), choice!(python_literal("."), python_literal("("), python_literal("="))))))).into()
}

fn wildcard_pattern() -> Combinator {
    tag("wildcard_pattern", crate::profile("wildcard_pattern", python_literal("_"))).into()
}

fn pattern_capture_target() -> Combinator {
    tag("pattern_capture_target", crate::profile("pattern_capture_target", seq!(negative_lookahead(seq!(python_literal("_"), opt(&WS))), &NAME, negative_lookahead(seq!(opt(&WS), choice!(python_literal("."), python_literal("("), python_literal("="))))))).into()
}

fn capture_pattern() -> Combinator {
    tag("capture_pattern", crate::profile("capture_pattern", &pattern_capture_target)).into()
}

fn imaginary_number() -> Combinator {
    tag("imaginary_number", crate::profile("imaginary_number", &NUMBER)).into()
}

fn real_number() -> Combinator {
    tag("real_number", crate::profile("real_number", &NUMBER)).into()
}

fn signed_real_number() -> Combinator {
    tag("signed_real_number", crate::profile("signed_real_number", choice!(
        &real_number,
...
fn signed_number() -> Combinator {
    tag("signed_number", crate::profile("signed_number", choice!(
        &NUMBER,
...
fn complex_number() -> Combinator {
    tag("complex_number", crate::profile("complex_number", seq!(&signed_real_number, opt(&WS), choice!(seq!(python_literal("+"), opt(&WS), &imaginary_number), seq!(python_literal("-"), opt(&WS), &imaginary_number))))).into()
}

fn literal_expr() -> Combinator {
    tag("literal_expr", crate::profile("literal_expr", choice!(
...
fn literal_pattern() -> Combinator {
    tag("literal_pattern", crate::profile("literal_pattern", choice!(
        seq!(&signed_number, negative_lookahead(seq!(opt(&WS), choice!(python_literal("+"), python_literal("-"))))),
        &complex_number,
        &strings,
        python_literal("None"),
...
fn closed_pattern() -> Combinator {
    cached(tag("closed_pattern", crate::profile("closed_pattern", choice!(
        &literal_pattern,
        &capture_pattern,
        &wildcard_pattern,
        &value_pattern,
...
fn or_pattern() -> Combinator {
    tag("or_pattern", crate::profile("or_pattern", seq!(&closed_pattern, opt(seq!(opt(&WS), python_literal("|"), opt(&WS), &closed_pattern, opt(repeat1(seq!(opt(&WS), python_literal("|"), opt(&WS), &closed_pattern)))))))).into()
}

fn as_pattern() -> Combinator {
    tag("as_pattern", crate::profile("as_pattern", seq!(
        &or_pattern,
         opt(&WS),
         python_literal("as"),
         opt(&WS),
...
fn pattern() -> Combinator {
    tag("pattern", crate::profile("pattern", choice!(
        &as_pattern,
        &or_pattern
    ))).into()
}
...
fn patterns() -> Combinator {
    tag("patterns", crate::profile("patterns", choice!(
...
fn guard() -> Combinator {
    tag("guard", crate::profile("guard", seq!(python_literal("if"), opt(&WS), &named_expression))).into()
}

fn case_block() -> Combinator {
    tag("case_block", crate::profile("case_block", seq!(
        python_literal("case"),
         opt(&WS),
         &patterns,
...
fn subject_expr() -> Combinator {
    tag("subject_expr", crate::profile("subject_expr", choice!(
...
fn match_stmt() -> Combinator {
    tag("match_stmt", crate::profile("match_stmt", seq!(
...
fn finally_block() -> Combinator {
    tag("finally_block", crate::profile("finally_block", seq!(
...
fn except_star_block() -> Combinator {
    tag("except_star_block", crate::profile("except_star_block", seq!(
...
fn except_block() -> Combinator {
    tag("except_block", crate::profile("except_block", seq!(python_literal("except"), opt(&WS), choice!(seq!(&expression, opt(seq!(opt(&WS), python_literal("as"), opt(&WS), &NAME)), opt(&WS), python_literal(":"), opt(&WS), &block), seq!(python_literal(":"), opt(&WS), &block))))).into()
}

fn try_stmt() -> Combinator {
    tag("try_stmt", crate::profile("try_stmt", seq!(
        python_literal("try"),
         opt(&WS),
         python_literal(":"),
         opt(&WS),
...
fn with_item() -> Combinator {
    tag("with_item", crate::profile("with_item", seq!(&expression, opt(seq!(opt(&WS), python_literal("as"), opt(&WS), &star_target, lookahead(seq!(opt(&WS), choice!(python_literal(","), python_literal(")"), python_literal(":"))))))))).into()
}

fn with_stmt() -> Combinator {
    tag("with_stmt", crate::profile("with_stmt", choice!(
...
fn for_stmt() -> Combinator {
    tag("for_stmt", crate::profile("for_stmt", choice!(
...
fn while_stmt() -> Combinator {
    tag("while_stmt", crate::profile("while_stmt", seq!(
...
fn else_block() -> Combinator {
    tag("else_block", crate::profile("else_block", seq!(
        python_literal("else"),
         opt(&WS),
         python_literal(":"),
         opt(&WS),
...
fn elif_stmt() -> Combinator {
    tag("elif_stmt", crate::profile("elif_stmt", seq!(
        python_literal("elif"),
         opt(&WS),
         &named_expression,
         opt(&WS),
...
fn if_stmt() -> Combinator {
    tag("if_stmt", crate::profile("if_stmt", seq!(
        python_literal("if"),
         opt(&WS),
         &named_expression,
         opt(&WS),
...
fn default() -> Combinator {
    tag("default", crate::profile("default", seq!(python_literal("="), opt(&WS), &expression))).into()
}

fn star_annotation() -> Combinator {
    tag("star_annotation", crate::profile("star_annotation", seq!(python_literal(":"), opt(&WS), &star_expression))).into()
}

fn annotation() -> Combinator {
    tag("annotation", crate::profile("annotation", seq!(python_literal(":"), opt(&WS), &expression))).into()
}

fn param_star_annotation() -> Combinator {
    tag("param_star_annotation", crate::profile("param_star_annotation", seq!(&NAME, opt(&WS), &star_annotation))).into()
}

fn param() -> Combinator {
    tag("param", crate::profile("param", seq!(&NAME, opt(seq!(opt(&WS), &annotation))))).into()
}

fn param_maybe_default() -> Combinator {
    tag("param_maybe_default", crate::profile("param_maybe_default", seq!(&param, opt(seq!(opt(&WS), &default)), choice!(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &TYPE_COMMENT))), seq!(opt(seq!(opt(&WS), &TYPE_COMMENT)), lookahead(seq!(opt(&WS), python_literal(")")))))))).into()
}

fn param_with_default() -> Combinator {
    tag("param_with_default", crate::profile("param_with_default", seq!(&param, opt(&WS), &default, choice!(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &TYPE_COMMENT))), seq!(opt(seq!(opt(&WS), &TYPE_COMMENT)), lookahead(seq!(opt(&WS), python_literal(")")))))))).into()
}

fn param_no_default_star_annotation() -> Combinator {
    tag("param_no_default_star_annotation", crate::profile("param_no_default_star_annotation", seq!(&param_star_annotation, choice!(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &TYPE_COMMENT))), seq!(opt(seq!(opt(&WS), &TYPE_COMMENT)), lookahead(seq!(opt(&WS), python_literal(")")))))))).into()
}

fn param_no_default() -> Combinator {
    tag("param_no_default", crate::profile("param_no_default", seq!(&param, choice!(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &TYPE_COMMENT))), seq!(opt(seq!(opt(&WS), &TYPE_COMMENT)), lookahead(seq!(opt(&WS), python_literal(")")))))))).into()
}

fn kwds() -> Combinator {
    tag("kwds", crate::profile("kwds", seq!(python_literal("**"), opt(&WS), &param_no_default))).into()
}

fn star_etc() -> Combinator {
    tag("star_etc", crate::profile("star_etc", choice!(
...
fn slash_with_default() -> Combinator {
    tag("slash_with_default", crate::profile("slash_with_default", seq!(
...
fn slash_no_default() -> Combinator {
    tag("slash_no_default", crate::profile("slash_no_default", seq!(
        &param_no_default,
...
fn parameters() -> Combinator {
    tag("parameters", crate::profile("parameters", choice!(
...
fn params() -> Combinator {
    tag("params", crate::profile("params", &parameters)).into()
}

fn function_def_raw() -> Combinator {
    tag("function_def_raw", crate::profile("function_def_raw", choice!(
...
fn function_def() -> Combinator {
    tag("function_def", crate::profile("function_def", choice!(
...
fn class_def_raw() -> Combinator {
    tag("class_def_raw", crate::profile("class_def_raw", seq!(
...
fn class_def() -> Combinator {
    tag("class_def", crate::profile("class_def", choice!(
...
fn decorators() -> Combinator {
    tag("decorators", crate::profile("decorators", seq!(
        python_literal("@"),
         opt(&WS),
         &named_expression,
         opt(&WS),
...
fn block() -> Combinator {
    cached(tag("block", crate::profile("block", choice!(
...
fn dotted_name() -> Combinator {
    tag("dotted_name", crate::profile("dotted_name", seq!(&NAME, opt(seq!(opt(&WS), python_literal("."), opt(&WS), &NAME, opt(repeat1(seq!(opt(&WS), python_literal("."), opt(&WS), &NAME)))))))).into()
}

fn dotted_as_name() -> Combinator {
    tag("dotted_as_name", crate::profile("dotted_as_name", seq!(&dotted_name, opt(seq!(opt(&WS), python_literal("as"), opt(&WS), &NAME))))).into()
}

fn dotted_as_names() -> Combinator {
    tag("dotted_as_names", crate::profile("dotted_as_names", seq!(&dotted_as_name, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &dotted_as_name, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &dotted_as_name)))))))).into()
}

fn import_from_as_name() -> Combinator {
    tag("import_from_as_name", crate::profile("import_from_as_name", seq!(&NAME, opt(seq!(opt(&WS), python_literal("as"), opt(&WS), &NAME))))).into()
}

fn import_from_as_names() -> Combinator {
    tag("import_from_as_names", crate::profile("import_from_as_names", seq!(&import_from_as_name, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &import_from_as_name, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &import_from_as_name)))))))).into()
}

fn import_from_targets() -> Combinator {
    tag("import_from_targets", crate::profile("import_from_targets", choice!(
...
fn assert_stmt() -> Combinator {
    tag("assert_stmt", crate::profile("assert_stmt", seq!(python_literal("assert"), opt(&WS), &expression, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &expression))))).into()
}

fn yield_stmt() -> Combinator {
    tag("yield_stmt", crate::profile("yield_stmt", &yield_expr)).into()
}

fn del_stmt() -> Combinator {
    tag("del_stmt", crate::profile("del_stmt", seq!(python_literal("del"), opt(&WS), &del_targets, lookahead(seq!(opt(&WS), choice!(python_literal(";"), &NEWLINE)))))).into()
}

fn nonlocal_stmt() -> Combinator {
    tag("nonlocal_stmt", crate::profile("nonlocal_stmt", seq!(python_literal("nonlocal"), opt(&WS), &NAME, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &NAME, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &NAME)))))))).into()
}

fn global_stmt() -> Combinator {
    tag("global_stmt", crate::profile("global_stmt", seq!(python_literal("global"), opt(&WS), &NAME, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &NAME, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &NAME)))))))).into()
}

fn raise_stmt() -> Combinator {
    tag("raise_stmt", crate::profile("raise_stmt", seq!(python_literal("raise"), opt(seq!(opt(&WS), &expression, opt(seq!(opt(&WS), python_literal("from"), opt(&WS), &expression))))))).into()
}

fn return_stmt() -> Combinator {
    tag("return_stmt", crate::profile("return_stmt", seq!(python_literal("return"), opt(seq!(opt(&WS), &star_expressions))))).into()
}

fn augassign() -> Combinator {
    tag("augassign", crate::profile("augassign", choice!(
        python_literal("+="),
        python_literal("-="),
        python_literal("*="),
        python_literal("@="),
...
fn annotated_rhs() -> Combinator {
    tag("annotated_rhs", crate::profile("annotated_rhs", choice!(
        &yield_expr,
        &star_expressions
    ))).into()
}
...
fn assignment() -> Combinator {
    tag("assignment", crate::profile("assignment", choice!(
...
fn compound_stmt() -> Combinator {
    tag("compound_stmt", crate::profile("compound_stmt", choice!(
...
fn simple_stmt() -> Combinator {
    cached(tag("simple_stmt", crate::profile("simple_stmt", choice!(
        &assignment,
...
fn simple_stmts() -> Combinator {
    tag("simple_stmts", crate::profile("simple_stmts", seq!(&simple_stmt, opt(&WS), choice!(seq!(negative_lookahead(seq!(python_literal(";"), opt(&WS))), &NEWLINE), seq!(opt(seq!(python_literal(";"), opt(&WS), &simple_stmt, opt(repeat1(seq!(opt(&WS), python_literal(";"), opt(&WS), &simple_stmt))), opt(&WS))), opt(seq!(python_literal(";"), opt(&WS))), &NEWLINE))))).into()
}

fn statement_newline() -> Combinator {
    tag("statement_newline", crate::profile("statement_newline", choice!(
...
fn statement() -> Combinator {
    tag("statement", crate::profile("statement", choice!(
        &compound_stmt,
        &simple_stmts
    ))).into()
}
...
fn statements() -> Combinator {
    tag("statements", crate::profile("statements", seq!(&statement, opt(repeat1(seq!(opt(&WS), &statement)))))).into()
}

fn func_type() -> Combinator {
    tag("func_type", crate::profile("func_type", seq!(
        python_literal("("),
...
fn eval() -> Combinator {
    tag("eval", crate::profile("eval", seq!(&expressions, opt(seq!(opt(&WS), &NEWLINE, opt(repeat1(seq!(opt(&WS), &NEWLINE))))), opt(&WS), &ENDMARKER))).into()
}

fn interactive() -> Combinator {
    tag("interactive", crate::profile("interactive", &statement_newline)).into()
}

fn file() -> Combinator {
    tag("file", crate::profile("file", seq!(opt(seq!(&statements, opt(&WS))), &ENDMARKER))).into()
}
