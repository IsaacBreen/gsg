...
pub fn python_file() -> Rc<DynCombinator> {
    ...
    let expression_without_invalid = Rc::new(expression_without_invalid.set(choice!(
        seq!(&conjunction, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("or"), &conjunction)))))), opt(choice!(seq!(eat_string("if"), &disjunction, eat_string("else"), &expression)))),
    ...
    let type_expressions = Rc::new(type_expressions.set(choice!(
        seq!(choice!(seq!(&disjunction, opt(choice!(seq!(eat_string("if"), &disjunction, eat_string("else"), &expression)))), seq!(&lambdef)), repeat1(eat_string(",")), opt(choice!(seq!(eat_string("*"), &expression, opt(choice!(seq!(eat_string(","), eat_string("**"), &expression)))), seq!(eat_string("**"), &expression)))),
    ...
    let star_targets_tuple_seq = Rc::new(star_targets_tuple_seq.set(choice!(
        seq!(&star_target, choice!(seq!(repeat1(choice!(seq!(eat_string(","), &star_target))), opt(choice!(seq!(eat_string(","))))), seq!(eat_string(","))))
    )).into_boxed());
    let star_targets_list_seq = Rc::new(star_targets_list_seq.set(choice!(
        seq!(&star_target, repeat1(eat_string(",")), opt(choice!(seq!(eat_string(",")))))
    )).into_boxed());
    let star_targets = Rc::new(star_targets.set(choice!(
        seq!(&star_target, opt(choice!(seq!(opt(choice!(seq!(repeat1(choice!(seq!(eat_string(","), &star_target)))))), opt(choice!(seq!(eat_string(","))))))))
    )).into_boxed());
    ...
    let kwargs = Rc::new(kwargs.set(choice!(
        seq!(&kwarg_or_starred, repeat1(eat_string(",")), opt(choice!(seq!(&kwarg_or_double_starred, repeat1(eat_string(",")))))),
        seq!(&kwarg_or_double_starred, repeat1(eat_string(",")))
    )).into_boxed());
    let args = Rc::new(args.set(choice!(
        seq!(choice!(seq!(&starred_expression), seq!(&NAME, eat_string(":="), &expression), seq!(&disjunction, opt(choice!(seq!(eat_string("if"), &disjunction, eat_string("else"), &expression)))), seq!(&lambdef)), repeat1(eat_string(",")), opt(choice!(seq!(eat_string(","), &kwargs)))),
        seq!(&kwargs)
    )).into_boxed());
    ...
    let for_if_clause = Rc::new(for_if_clause.set(choice!(
        seq!(eat_string("async"), eat_string("for"), &star_targets, eat_string("in"), &disjunction, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("if"), &disjunction))))))),
        seq!(eat_string("for"), &star_targets, eat_string("in"), &disjunction, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("if"), &disjunction)))))))
    )).into_boxed());
    ...
    let double_starred_kvpairs = Rc::new(double_starred_kvpairs.set(choice!(
        seq!(&double_starred_kvpair, repeat1(eat_string(",")), opt(choice!(seq!(eat_string(",")))))
    )).into_boxed());
    ...
    let fstring_full_format_spec = Rc::new(fstring_full_format_spec.set(choice!(
        seq!(eat_string(":"), opt(choice!(seq!(repeat1(&fstring_format_spec)))))
    )).into_boxed());
    ...
    let lambda_star_etc = Rc::new(lambda_star_etc.set(choice!(
        seq!(eat_string("*"), choice!(seq!(&lambda_param_no_default, opt(choice!(seq!(repeat1(&lambda_param_maybe_default)))), opt(choice!(seq!(&lambda_kwds)))), seq!(eat_string(","), repeat1(&lambda_param_maybe_default), opt(choice!(seq!(&lambda_kwds)))))),
        seq!(&lambda_kwds)
    )).into_boxed());
    let lambda_slash_with_default = Rc::new(lambda_slash_with_default.set(choice!(
        seq!(opt(choice!(seq!(repeat1(&lambda_param_no_default)))), repeat1(&lambda_param_with_default), eat_string("/"), opt(choice!(seq!(eat_string(",")))), opt(choice!(seq!(repeat1(choice!(seq!(repeat1(&lambda_param_with_default), eat_string("/"), opt(choice!(seq!(eat_string(",")))))))))))
    )).into_boxed());
    let lambda_slash_no_default = Rc::new(lambda_slash_no_default.set(choice!(
        seq!(repeat1(&lambda_param_no_default), eat_string("/"), opt(choice!(seq!(eat_string(",")))))
    )).into_boxed());
    ...
    let atom = Rc::new(atom.set(choice!(
        seq!(choice!(seq!(&NAME), seq!(eat_string("True")), seq!(eat_string("False")), seq!(eat_string("None")), seq!(&strings), seq!(&NUMBER), seq!(&tuple), seq!(&group), seq!(&genexp), seq!(&list), seq!(&listcomp), seq!(&dict), seq!(&set), seq!(&dictcomp), seq!(&setcomp), seq!(eat_string("..."))), opt(choice!(seq!(repeat1(choice!(seq!(&strings), seq!(&tuple), seq!(&group), seq!(&genexp), seq!(&list), seq!(&listcomp), seq!(&dict), seq!(&set), seq!(&dictcomp), seq!(&setcomp)))))))
    )).into_boxed());
    let slice = Rc::new(slice.set(choice!(
        seq!(choice!(seq!(opt(choice!(seq!(&disjunction, opt(choice!(seq!(eat_string("if"), &disjunction, eat_string("else"), &expression)))), seq!(&lambdef))), eat_string(":"), opt(choice!(seq!(&expression))), opt(choice!(seq!(eat_string(":"), opt(choice!(seq!(&expression))))))), seq!(&NAME, eat_string(":="), &expression), seq!(&disjunction, opt(choice!(seq!(eat_string("if"), &disjunction, eat_string("else"), &expression)))), seq!(&lambdef)), opt(choice!(seq!(repeat1(choice!(seq!(eat_string(":"), opt(choice!(seq!(&expression))), opt(choice!(seq!(eat_string(":"), opt(choice!(seq!(&expression)))))))))))))
    )).into_boxed());
    let slices = Rc::new(slices.set(choice!(
        seq!(&slice),
        seq!(choice!(seq!(&slice), seq!(&starred_expression)), repeat1(eat_string(",")), opt(choice!(seq!(eat_string(",")))))
    )).into_boxed());
    let primary = Rc::new(primary.set(choice!(
        seq!(&atom, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("."), &NAME), seq!(&genexp), seq!(eat_string("("), opt(choice!(seq!(&arguments))), eat_string(")")), seq!(eat_string("["), &slices, eat_string("]"))))))))
    )).into_boxed());
    ...
    let term = Rc::new(term.set(choice!(
        seq!(&factor, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("*"), &factor), seq!(eat_string("/"), &factor), seq!(eat_string("//"), &factor), seq!(eat_string("%"), &factor), seq!(eat_string("@"), &factor)))))))
    )).into_boxed());
    let sum = Rc::new(sum.set(choice!(
        seq!(&term, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("+"), &term), seq!(eat_string("-"), &term)))))))
    )).into_boxed());
    let shift_expr = Rc::new(shift_expr.set(choice!(
        seq!(&sum, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("<<"), &sum), seq!(eat_string(">>"), &sum)))))))
    )).into_boxed());
    let bitwise_and = Rc::new(bitwise_and.set(choice!(
        seq!(&shift_expr, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("&"), &shift_expr)))))))
    )).into_boxed());
    let bitwise_xor = Rc::new(bitwise_xor.set(choice!(
        seq!(&bitwise_and, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("^"), &bitwise_and)))))))
    )).into_boxed());
    let bitwise_or = Rc::new(bitwise_or.set(choice!(
        seq!(&bitwise_xor, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("|"), &bitwise_xor)))))))
    )).into_boxed());
    ...
    let conjunction = Rc::new(conjunction.set(choice!(
        seq!(&inversion, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("and"), &inversion)))))))
    )).into_boxed());
    let disjunction = Rc::new(disjunction.set(choice!(
        seq!(&conjunction, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("or"), &conjunction)))))))
    )).into_boxed());
    ...
    let star_named_expressions = Rc::new(star_named_expressions.set(choice!(
        seq!(&star_named_expression, repeat1(eat_string(",")), opt(choice!(seq!(eat_string(",")))))
    )).into_boxed());
    ...
    let star_expressions = Rc::new(star_expressions.set(choice!(
        seq!(&star_expression, opt(choice!(seq!(repeat1(choice!(seq!(eat_string(","), &star_expression))), opt(choice!(seq!(eat_string(","))))), seq!(eat_string(",")))))
    )).into_boxed());
    ...
    let expressions = Rc::new(expressions.set(choice!(
        seq!(&expression, opt(choice!(seq!(repeat1(choice!(seq!(eat_string(","), &expression))), opt(choice!(seq!(eat_string(","))))), seq!(eat_string(",")))))
    )).into_boxed());
    ...
    let type_param_seq = Rc::new(type_param_seq.set(choice!(
        seq!(&type_param, repeat1(eat_string(",")), opt(choice!(seq!(eat_string(",")))))
    )).into_boxed());
    ...
    let keyword_patterns = Rc::new(keyword_patterns.set(choice!(
        seq!(&keyword_pattern, repeat1(eat_string(",")))
    )).into_boxed());
    let positional_patterns = Rc::new(positional_patterns.set(choice!(
        seq!(choice!(seq!(&as_pattern), seq!(&or_pattern)), repeat1(eat_string(",")))
    )).into_boxed());
    let class_pattern = Rc::new(class_pattern.set(choice!(
        seq!(&NAME, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("."), &NAME)))))), eat_string("("), choice!(seq!(eat_string(")")), seq!(&positional_patterns, choice!(seq!(opt(choice!(seq!(eat_string(",")))), eat_string(")")), seq!(eat_string(","), &keyword_patterns, opt(choice!(seq!(eat_string(",")))), eat_string(")")))), seq!(&keyword_patterns, opt(choice!(seq!(eat_string(",")))), eat_string(")"))))
    )).into_boxed());
    ...
    let items_pattern = Rc::new(items_pattern.set(choice!(
        seq!(&key_value_pattern, repeat1(eat_string(",")))
    )).into_boxed());
    ...
    let maybe_sequence_pattern = Rc::new(maybe_sequence_pattern.set(choice!(
        seq!(&maybe_star_pattern, repeat1(eat_string(",")), opt(choice!(seq!(eat_string(",")))))
    )).into_boxed());
    ...
    let name_or_attr = Rc::new(name_or_attr.set(choice!(
        seq!(&NAME, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("."), &NAME)))))))
    )).into_boxed());
    ...
    let or_pattern = Rc::new(or_pattern.set(choice!(
        seq!(&closed_pattern, repeat1(eat_string("|")))
    )).into_boxed());
    ...
    let match_stmt = Rc::new(match_stmt.set(choice!(
        seq!(eat_string("atc"), &subject_expr, eat_string(":"), &NEWLINE, &INDENT, repeat1(&case_block), &DEDENT)
    )).into_boxed());
    ...
    let try_stmt = Rc::new(try_stmt.set(choice!(
        seq!(eat_string("try"), eat_string(":"), &block, choice!(seq!(&finally_block), seq!(repeat1(&except_block), opt(choice!(seq!(&else_block))), opt(choice!(seq!(&finally_block)))), seq!(repeat1(&except_star_block), opt(choice!(seq!(&else_block))), opt(choice!(seq!(&finally_block))))))
    )).into_boxed());
    ...
    let with_stmt = Rc::new(with_stmt.set(choice!(
        seq!(eat_string("with"), choice!(seq!(eat_string("("), &with_item, repeat1(eat_string(",")), opt(choice!(seq!(eat_string(",")))), eat_string(")"), eat_string(":"), opt(choice!(seq!(&TYPE_COMMENT))), &block), seq!(&with_item, repeat1(eat_string(",")), eat_string(":"), opt(choice!(seq!(&TYPE_COMMENT))), &block))),
        seq!(eat_string("async"), eat_string("with"), choice!(seq!(eat_string("("), &with_item, repeat1(eat_string(",")), opt(choice!(seq!(eat_string(",")))), eat_string(")"), eat_string(":"), &block), seq!(&with_item, repeat1(eat_string(",")), eat_string(":"), opt(choice!(seq!(&TYPE_COMMENT))), &block)))
    )).into_boxed());
    ...
    let star_etc = Rc::new(star_etc.set(choice!(
        seq!(eat_string("*"), choice!(seq!(&param_no_default, opt(choice!(seq!(repeat1(&param_maybe_default)))), opt(choice!(seq!(&kwds)))), seq!(&param_no_default_star_annotation, opt(choice!(seq!(repeat1(&param_maybe_default)))), opt(choice!(seq!(&kwds)))), seq!(eat_string(","), repeat1(&param_maybe_default), opt(choice!(seq!(&kwds)))))),
        seq!(&kwds)
    )).into_boxed());
    let slash_with_default = Rc::new(slash_with_default.set(choice!(
        seq!(opt(choice!(seq!(repeat1(&param_no_default)))), repeat1(&param_with_default), eat_string("/"), opt(choice!(seq!(eat_string(",")))), opt(choice!(seq!(repeat1(choice!(seq!(repeat1(&param_with_default), eat_string("/"), opt(choice!(seq!(eat_string(",")))))))))))
    )).into_boxed());
    let slash_no_default = Rc::new(slash_no_default.set(choice!(
        seq!(repeat1(&param_no_default), eat_string("/"), opt(choice!(seq!(eat_string(",")))))
    )).into_boxed());
    ...
    let function_def = Rc::new(function_def.set(choice!(
        seq!(eat_string("@"), &named_expression, &NEWLINE, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("@"), &named_expression, &NEWLINE)))))), &function_def_raw),
    ...
    let class_def = Rc::new(class_def.set(choice!(
        seq!(eat_string("@"), &named_expression, &NEWLINE, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("@"), &named_expression, &NEWLINE)))))), &class_def_raw),
        seq!(&class_def_raw)
    )).into_boxed());
    let decorators = Rc::new(decorators.set(choice!(
        seq!(eat_string("@"), &named_expression, &NEWLINE, opt(choice!(seq!(repeat1(choice!(seq!(eat_string("@"), &named_expression, &NEWLINE)))))))
    )).into_boxed());
    let block = Rc::new(block.set(choice!(
        seq!(&NEWLINE, &INDENT, &statements, &DEDENT),
        seq!(&simple_stmt, choice!(seq!(&NEWLINE), seq!(repeat1(eat_string(";")), opt(choice!(seq!(eat_string(";")))), &NEWLINE)))
    )).into_boxed());
    ...
    let dotted_as_names = Rc::new(dotted_as_names.set(choice!(
        seq!(&dotted_as_name, repeat1(eat_string(",")))
    )).into_boxed());
    ...
    let import_from_as_names = Rc::new(import_from_as_names.set(choice!(
        seq!(&import_from_as_name, repeat1(eat_string(",")))
    )).into_boxed());
    ...
    let import_from = Rc::new(import_from.set(choice!(
        seq!(eat_string("from"), choice!(seq!(opt(choice!(seq!(repeat1(choice!(seq!(eat_string(".")), seq!(eat_string("..."))))))), &dotted_name, eat_string("import"), &import_from_targets), seq!(repeat1(choice!(seq!(eat_string(".")), seq!(eat_string("...")))), eat_string("import"), &import_from_targets)))
    )).into_boxed());
    ...
    let nonlocal_stmt = Rc::new(nonlocal_stmt.set(choice!(
        seq!(eat_string("nonlocal"), &NAME, repeat1(eat_string(",")))
    )).into_boxed());
    let global_stmt = Rc::new(global_stmt.set(choice!(
        seq!(eat_string("global"), &NAME, repeat1(eat_string(",")))
    )).into_boxed());
    ...
    let assignment = Rc::new(assignment.set(choice!(
        ...
        seq!(&star_targets, eat_string("="), opt(choice!(seq!(repeat1(choice!(seq!(&star_targets, eat_string("="))))))), choice!(seq!(&yield_expr), seq!(&star_expressions)), opt(choice!(seq!(&TYPE_COMMENT)))),
    ...
    let simple_stmt = Rc::new(simple_stmt.set(choice!(
        seq!(choice!(seq!(&assignment), seq!(&type_alias), seq!(&star_expressions), seq!(&return_stmt), seq!(&import_stmt), seq!(&raise_stmt), seq!(eat_string("pass")), seq!(&del_stmt), seq!(&yield_stmt), seq!(&assert_stmt), seq!(eat_string("break")), seq!(eat_string("continue")), seq!(&global_stmt), seq!(&nonlocal_stmt)), opt(choice!(seq!(repeat1(choice!(seq!(&type_alias), seq!(&return_stmt), seq!(&import_stmt), seq!(&raise_stmt), seq!(&del_stmt), seq!(&yield_stmt), seq!(&assert_stmt), seq!(&global_stmt), seq!(&nonlocal_stmt)))))))
    )).into_boxed());
    ...
    let func_type = Rc::new(func_type.set(choice!(
        seq!(eat_string("("), opt(choice!(seq!(&type_expressions))), eat_string(")"), eat_string("->"), &expression, opt(choice!(seq!(repeat1(&NEWLINE)))), &ENDMARKER)
    )).into_boxed());
