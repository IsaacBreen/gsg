...
pub fn python_file() -> Rc<DynCombinator> {
    let WS = tag("WS", seq!(prevent_consecutive_matches_check_not("WS"), WS(), prevent_consecutive_matches(&["INDENT","WS"]))).into_rc_dyn();
    let NAME = tag("NAME", seq!(prevent_consecutive_matches_check_not("NAME"), NAME(), prevent_consecutive_matches(&[]))).into_rc_dyn();
    ...
    let FSTRING_MIDDLE = tag("FSTRING_MIDDLE", seq!(prevent_consecutive_matches_check_not("FSTRING_MIDDLE"), FSTRING_MIDDLE(), prevent_consecutive_matches(&["FSTRING_MIDDLE"]))).into_rc_dyn();
    ...
    let NUMBER = tag("NUMBER", seq!(prevent_consecutive_matches_check_not("NUMBER"), NUMBER(), prevent_consecutive_matches(&[]))).into_rc_dyn();
    let STRING = tag("STRING", seq!(prevent_consecutive_matches_check_not("STRING"), STRING(), prevent_consecutive_matches(&[]))).into_rc_dyn();
    let NEWLINE = tag("NEWLINE", seq!(prevent_consecutive_matches_check_not("NEWLINE"), NEWLINE(), prevent_consecutive_matches(&[]))).into_rc_dyn();
    let INDENT = tag("INDENT", seq!(prevent_consecutive_matches_check_not("INDENT"), INDENT(), prevent_consecutive_matches(&[]))).into_rc_dyn();
    let DEDENT = tag("DEDENT", seq!(prevent_consecutive_matches_check_not("DEDENT"), DEDENT(), prevent_consecutive_matches(&[]))).into_rc_dyn();
