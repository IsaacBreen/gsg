...
pub fn python_file() -> Combinator {
    ...
    expression_without_invalid.set(tag("expression_without_invalid", choice!(
    ...
    func_type_comment.set(tag("func_type_comment", choice!(
        seq!(&NEWLINE, opt(&WS), &TYPE_COMMENT, lookahead(seq!(&NEWLINE, &INDENT))),
        &TYPE_COMMENT
    )));
    type_expressions.set(tag("type_expressions", choice!(
    ...
    del_t_atom.set(tag("del_t_atom", choice!(
        &NAME,
    ...
    del_target.set(cached(tag("del_target", choice!(
    ...
    del_targets.set(tag("del_targets", seq!(&del_target, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &del_target, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &del_target))))), opt(seq!(opt(&WS), python_literal(","))))));
    t_lookahead.set(tag("t_lookahead", choice!(
        python_literal("("),
        python_literal("["),
        python_literal(".")
    )));
    t_primary.set(tag("t_primary", seq!(choice!(&NAME, python_literal("True"), python_literal("False"), python_literal("None"), seq!(lookahead(choice!(&STRING, &FSTRING_START)), &strings), &NUMBER, seq!(lookahead(python_literal("(")), choice!(&tuple, &group, &genexp)), seq!(lookahead(python_literal("[")), choice!(&list, &listcomp)), seq!(lookahead(python_literal("{")), choice!(&dict, &set, &dictcomp, &setcomp)), python_literal("...")), lookahead(&t_lookahead), opt(seq!(opt(&WS), choice!(seq!(python_literal("."), opt(&WS), &NAME, lookahead(&t_lookahead)), seq!(python_literal("["), opt(&WS), &slices, opt(&WS), python_literal("]"), lookahead(&t_lookahead)), seq!(&genexp, lookahead(&t_lookahead)), seq!(python_literal("("), opt(seq!(opt(&WS), &arguments)), opt(&WS), python_literal(")"), lookahead(&t_lookahead))), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("."), opt(&WS), &NAME, lookahead(&t_lookahead)), seq!(python_literal("["), opt(&WS), &slices, opt(&WS), python_literal("]"), lookahead(&t_lookahead)), seq!(&genexp, lookahead(&t_lookahead)), seq!(python_literal("("), opt(seq!(opt(&WS), &arguments)), opt(&WS), python_literal(")"), lookahead(&t_lookahead)))))))))));
    single_subscript_attribute_target.set(tag("single_subscript_attribute_target", seq!(&t_primary, opt(&WS), choice!(seq!(python_literal("."), opt(&WS), &NAME, negative_lookahead(&t_lookahead)), seq!(python_literal("["), opt(&WS), &slices, opt(&WS), python_literal("]"), negative_lookahead(&t_lookahead))))));
    single_target.set(tag("single_target", choice!(
        &single_subscript_attribute_target,
        &NAME,
        seq!(python_literal("("), opt(&WS), &single_target, opt(&WS), python_literal(")"))
    )));
    star_atom.set(tag("star_atom", choice!(
        &NAME,
    ...
    target_with_star_atom.set(cached(tag("target_with_star_atom", choice!(
    ...
    star_target.set(cached(tag("star_target", choice!(
        seq!(python_literal("*"), negative_lookahead(python_literal("*")), opt(&WS), &star_target),
        &target_with_star_atom
    ))));
    star_targets_tuple_seq.set(tag("star_targets_tuple_seq", seq!(&star_target, opt(&WS), python_literal(","), opt(seq!(opt(&WS), &star_target, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target))), opt(seq!(opt(&WS), python_literal(","))))))));
    star_targets_list_seq.set(tag("star_targets_list_seq", seq!(&star_target, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target))))), opt(seq!(opt(&WS), python_literal(","))))));
    star_targets.set(tag("star_targets", seq!(&star_target, choice!(negative_lookahead(python_literal(",")), seq!(opt(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_target))))), opt(seq!(opt(&WS), python_literal(","))))))));
    kwarg_or_double_starred.set(tag("kwarg_or_double_starred", choice!(
        seq!(&NAME, opt(&WS), python_literal("="), opt(&WS), &expression),
        seq!(python_literal("**"), opt(&WS), &expression)
    )));
    kwarg_or_starred.set(tag("kwarg_or_starred", choice!(
        seq!(&NAME, opt(&WS), python_literal("="), opt(&WS), &expression),
        seq!(python_literal("*"), opt(&WS), &expression)
    )));
    starred_expression.set(tag("starred_expression", seq!(python_literal("*"), opt(&WS), &expression)));
    kwargs.set(tag("kwargs", choice!(
    ...
    arguments.set(cached(tag("arguments", seq!(&args, opt(seq!(opt(&WS), python_literal(","))), lookahead(python_literal(")"))))));
    dictcomp.set(tag("dictcomp", seq!(
        python_literal("{"),
         opt(&WS),
         &kvpair,
         opt(&WS),
    ...
    for_if_clause.set(tag("for_if_clause", choice!(
    ...
    for_if_clauses.set(tag("for_if_clauses", seq!(&for_if_clause, opt(repeat1(seq!(opt(&WS), &for_if_clause))))));
    kvpair.set(tag("kvpair", seq!(
    ...
    double_starred_kvpair.set(tag("double_starred_kvpair", choice!(
        seq!(python_literal("**"), opt(&WS), &bitwise_or),
        &kvpair
    )));
    double_starred_kvpairs.set(tag("double_starred_kvpairs", seq!(&double_starred_kvpair, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &double_starred_kvpair, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &double_starred_kvpair))))), opt(seq!(opt(&WS), python_literal(","))))));
    dict.set(tag("dict", seq!(python_literal("{"), opt(seq!(opt(&WS), &double_starred_kvpairs)), opt(&WS), python_literal("}"))));
    set.set(tag("set", seq!(
        python_literal("{"),
         opt(&WS),
    ...
    tuple.set(tag("tuple", seq!(python_literal("("), opt(seq!(opt(&WS), &star_named_expression, opt(&WS), python_literal(","), opt(seq!(opt(&WS), &star_named_expressions)))), opt(&WS), python_literal(")"))));
    list.set(tag("list", seq!(python_literal("["), opt(seq!(opt(&WS), &star_named_expressions)), opt(&WS), python_literal("]"))));
    strings.set(cached(tag("strings", seq!(choice!(seq!(&FSTRING_START, opt(seq!(opt(&WS), &fstring_middle, opt(repeat1(seq!(opt(&WS), &fstring_middle))))), opt(&WS), &FSTRING_END), &STRING), opt(repeat1(seq!(opt(&WS), choice!(seq!(&FSTRING_START, opt(seq!(opt(&WS), &fstring_middle, opt(repeat1(seq!(opt(&WS), &fstring_middle))))), opt(&WS), &FSTRING_END), &STRING))))))));
    string.set(tag("string", &STRING));
    fstring.set(tag("fstring", seq!(&FSTRING_START, opt(seq!(opt(&WS), &fstring_middle, opt(repeat1(seq!(opt(&WS), &fstring_middle))))), opt(&WS), &FSTRING_END)));
    fstring_format_spec.set(tag("fstring_format_spec", choice!(
        &FSTRING_MIDDLE,
    ...
    fstring_full_format_spec.set(tag("fstring_full_format_spec", seq!(python_literal(":"), opt(seq!(opt(&WS), &fstring_format_spec, opt(repeat1(seq!(opt(&WS), &fstring_format_spec))))))));
    fstring_conversion.set(tag("fstring_conversion", seq!(python_literal("!"), opt(&WS), &NAME)));
    fstring_replacement_field.set(tag("fstring_replacement_field", seq!(
        python_literal("{"),
         opt(&WS),
         &annotated_rhs,
    ...
    fstring_middle.set(tag("fstring_middle", choice!(
        &fstring_replacement_field,
        &FSTRING_MIDDLE
    )));
    lambda_param.set(tag("lambda_param", &NAME));
    lambda_param_maybe_default.set(tag("lambda_param_maybe_default", seq!(&lambda_param, opt(seq!(opt(&WS), &default)), choice!(seq!(opt(&WS), python_literal(",")), lookahead(python_literal(":"))))));
    lambda_param_with_default.set(tag("lambda_param_with_default", seq!(&lambda_param, opt(&WS), &default, choice!(seq!(opt(&WS), python_literal(",")), lookahead(python_literal(":"))))));
    lambda_param_no_default.set(tag("lambda_param_no_default", seq!(&lambda_param, choice!(seq!(opt(&WS), python_literal(",")), lookahead(python_literal(":"))))));
    lambda_kwds.set(tag("lambda_kwds", seq!(python_literal("**"), opt(&WS), &lambda_param_no_default)));
    lambda_star_etc.set(tag("lambda_star_etc", choice!(
    ...
    lambda_slash_with_default.set(tag("lambda_slash_with_default", seq!(
    ...
    lambda_slash_no_default.set(tag("lambda_slash_no_default", seq!(
    ...
    lambda_parameters.set(tag("lambda_parameters", choice!(
    ...
    lambda_params.set(tag("lambda_params", &lambda_parameters));
    lambdef.set(tag("lambdef", seq!(
    ...
    primary.set(tag("primary", seq!(&atom, opt(seq!(opt(&WS), choice!(seq!(python_literal("."), opt(&WS), &NAME), &genexp, seq!(python_literal("("), opt(seq!(opt(&WS), &arguments)), opt(&WS), python_literal(")")), seq!(python_literal("["), opt(&WS), &slices, opt(&WS), python_literal("]"))), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("."), opt(&WS), &NAME), &genexp, seq!(python_literal("("), opt(seq!(opt(&WS), &arguments)), opt(&WS), python_literal(")")), seq!(python_literal("["), opt(&WS), &slices, opt(&WS), python_literal("]")))))))))));
    await_primary.set(cached(tag("await_primary", choice!(
        seq!(python_literal("await"), opt(&WS), &primary),
        &primary
    ))));
    power.set(tag("power", seq!(&await_primary, opt(seq!(opt(&WS), python_literal("**"), opt(&WS), &factor)))));
    factor.set(cached(tag("factor", choice!(
        seq!(python_literal("+"), opt(&WS), &factor),
        seq!(python_literal("-"), opt(&WS), &factor),
        seq!(python_literal("~"), opt(&WS), &factor),
        &power
    ))));
    term.set(tag("term", seq!(&factor, opt(seq!(opt(&WS), choice!(seq!(python_literal("*"), opt(&WS), &factor), seq!(python_literal("/"), opt(&WS), &factor), seq!(python_literal("//"), opt(&WS), &factor), seq!(python_literal("%"), opt(&WS), &factor), seq!(python_literal("@"), opt(&WS), &factor)), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("*"), opt(&WS), &factor), seq!(python_literal("/"), opt(&WS), &factor), seq!(python_literal("//"), opt(&WS), &factor), seq!(python_literal("%"), opt(&WS), &factor), seq!(python_literal("@"), opt(&WS), &factor))))))))));
    sum.set(tag("sum", seq!(&term, opt(seq!(opt(&WS), choice!(seq!(python_literal("+"), opt(&WS), &term), seq!(python_literal("-"), opt(&WS), &term)), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("+"), opt(&WS), &term), seq!(python_literal("-"), opt(&WS), &term))))))))));
    shift_expr.set(tag("shift_expr", seq!(&sum, opt(seq!(opt(&WS), choice!(seq!(python_literal("<<"), opt(&WS), &sum), seq!(python_literal(">>"), opt(&WS), &sum)), opt(repeat1(seq!(opt(&WS), choice!(seq!(python_literal("<<"), opt(&WS), &sum), seq!(python_literal(">>"), opt(&WS), &sum))))))))));
    bitwise_and.set(tag("bitwise_and", seq!(&shift_expr, opt(seq!(opt(&WS), python_literal("&"), opt(&WS), &shift_expr, opt(repeat1(seq!(opt(&WS), python_literal("&"), opt(&WS), &shift_expr))))))));
    bitwise_xor.set(tag("bitwise_xor", seq!(&bitwise_and, opt(seq!(opt(&WS), python_literal("^"), opt(&WS), &bitwise_and, opt(repeat1(seq!(opt(&WS), python_literal("^"), opt(&WS), &bitwise_and))))))));
    bitwise_or.set(tag("bitwise_or", seq!(&bitwise_xor, opt(seq!(opt(&WS), python_literal("|"), opt(&WS), &bitwise_xor, opt(repeat1(seq!(opt(&WS), python_literal("|"), opt(&WS), &bitwise_xor))))))));
    is_bitwise_or.set(tag("is_bitwise_or", seq!(python_literal("is"), opt(&WS), &bitwise_or)));
    isnot_bitwise_or.set(tag("isnot_bitwise_or", seq!(
        python_literal("is"),
         opt(&WS),
         python_literal("not"),
         opt(&WS),
    ...
    in_bitwise_or.set(tag("in_bitwise_or", seq!(python_literal("in"), opt(&WS), &bitwise_or)));
    notin_bitwise_or.set(tag("notin_bitwise_or", seq!(
        python_literal("not"),
         opt(&WS),
         python_literal("in"),
         opt(&WS),
    ...
    gt_bitwise_or.set(tag("gt_bitwise_or", seq!(python_literal(">"), opt(&WS), &bitwise_or)));
    gte_bitwise_or.set(tag("gte_bitwise_or", seq!(python_literal(">="), opt(&WS), &bitwise_or)));
    lt_bitwise_or.set(tag("lt_bitwise_or", seq!(python_literal("<"), opt(&WS), &bitwise_or)));
    lte_bitwise_or.set(tag("lte_bitwise_or", seq!(python_literal("<="), opt(&WS), &bitwise_or)));
    noteq_bitwise_or.set(tag("noteq_bitwise_or", seq!(python_literal("!="), opt(&WS), &bitwise_or)));
    eq_bitwise_or.set(tag("eq_bitwise_or", seq!(python_literal("=="), opt(&WS), &bitwise_or)));
    compare_op_bitwise_or_pair.set(tag("compare_op_bitwise_or_pair", choice!(
        &eq_bitwise_or,
        &noteq_bitwise_or,
        &lte_bitwise_or,
        &lt_bitwise_or,
    ...
    comparison.set(tag("comparison", seq!(&bitwise_or, opt(seq!(opt(&WS), &compare_op_bitwise_or_pair, opt(repeat1(seq!(opt(&WS), &compare_op_bitwise_or_pair))))))));
    inversion.set(cached(tag("inversion", choice!(
        seq!(python_literal("not"), opt(&WS), &inversion),
        &comparison
    ))));
    conjunction.set(cached(tag("conjunction", seq!(&inversion, opt(seq!(opt(&WS), python_literal("and"), opt(&WS), &inversion, opt(repeat1(seq!(opt(&WS), python_literal("and"), opt(&WS), &inversion)))))))));
    disjunction.set(cached(tag("disjunction", seq!(&conjunction, opt(seq!(opt(&WS), python_literal("or"), opt(&WS), &conjunction, opt(repeat1(seq!(opt(&WS), python_literal("or"), opt(&WS), &conjunction)))))))));
    named_expression.set(tag("named_expression", choice!(
        seq!(&NAME, opt(&WS), python_literal(":="), opt(&WS), &expression),
    ...
    assignment_expression.set(tag("assignment_expression", seq!(
        &NAME,
         opt(&WS),
         python_literal(":="),
         opt(&WS),
    ...
    star_named_expression.set(tag("star_named_expression", choice!(
        seq!(python_literal("*"), opt(&WS), &bitwise_or),
        &named_expression
    )));
    star_named_expressions.set(tag("star_named_expressions", seq!(&star_named_expression, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &star_named_expression, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_named_expression))))), opt(seq!(opt(&WS), python_literal(","))))));
    star_expression.set(cached(tag("star_expression", choice!(
        seq!(python_literal("*"), opt(&WS), &bitwise_or),
        choice!(seq!(&disjunction, opt(seq!(opt(&WS), python_literal("if"), opt(&WS), &disjunction, opt(&WS), python_literal("else"), opt(&WS), &expression))), &lambdef)
    ))));
    star_expressions.set(tag("star_expressions", seq!(&star_expression, opt(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &star_expression, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &star_expression))), opt(seq!(opt(&WS), python_literal(","))))))))));
    yield_expr.set(tag("yield_expr", seq!(python_literal("yield"), choice!(seq!(opt(&WS), python_literal("from"), opt(&WS), &expression), opt(seq!(opt(&WS), &star_expressions))))));
    expression.set(cached(tag("expression", choice!(
        seq!(&disjunction, opt(seq!(opt(&WS), python_literal("if"), opt(&WS), &disjunction, opt(&WS), python_literal("else"), opt(&WS), &expression))),
        &lambdef
    ))));
    expressions.set(tag("expressions", seq!(&expression, opt(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &expression, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &expression))), opt(seq!(opt(&WS), python_literal(","))))))))));
    type_param_starred_default.set(tag("type_param_starred_default", seq!(python_literal("="), opt(&WS), &star_expression)));
    type_param_default.set(tag("type_param_default", seq!(python_literal("="), opt(&WS), &expression)));
    type_param_bound.set(tag("type_param_bound", seq!(python_literal(":"), opt(&WS), &expression)));
    type_param.set(cached(tag("type_param", choice!(
    ...
    type_param_seq.set(tag("type_param_seq", seq!(&type_param, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &type_param, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &type_param))))), opt(seq!(opt(&WS), python_literal(","))))));
    type_params.set(tag("type_params", seq!(
        python_literal("["),
         opt(&WS),
         &type_param_seq,
         opt(&WS),
    ...
    type_alias.set(tag("type_alias", seq!(
        python_literal("type"),
         opt(&WS),
         &NAME,
    ...
    keyword_pattern.set(tag("keyword_pattern", seq!(
        &NAME,
         opt(&WS),
         python_literal("="),
         opt(&WS),
    ...
    keyword_patterns.set(tag("keyword_patterns", seq!(&keyword_pattern, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &keyword_pattern, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &keyword_pattern))))))));
    positional_patterns.set(tag("positional_patterns", seq!(choice!(&as_pattern, &or_pattern), opt(seq!(opt(&WS), python_literal(","), opt(&WS), &pattern, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &pattern))))))));
    class_pattern.set(tag("class_pattern", seq!(
        &NAME,
    ...
    double_star_pattern.set(tag("double_star_pattern", seq!(python_literal("**"), opt(&WS), &pattern_capture_target)));
    key_value_pattern.set(tag("key_value_pattern", seq!(
    ...
    items_pattern.set(tag("items_pattern", seq!(&key_value_pattern, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &key_value_pattern, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &key_value_pattern))))))));
    ...
    star_pattern.set(cached(tag("star_pattern", seq!(python_literal("*"), opt(&WS), choice!(&pattern_capture_target, &wildcard_pattern)))));
    maybe_star_pattern.set(tag("maybe_star_pattern", choice!(
        &star_pattern,
        choice!(&as_pattern, &or_pattern)
    )));
    maybe_sequence_pattern.set(tag("maybe_sequence_pattern", seq!(&maybe_star_pattern, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &maybe_star_pattern, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &maybe_star_pattern))))), opt(seq!(opt(&WS), python_literal(","))))));
    open_sequence_pattern.set(tag("open_sequence_pattern", seq!(&maybe_star_pattern, opt(&WS), python_literal(","), opt(seq!(opt(&WS), &maybe_sequence_pattern)))));
    sequence_pattern.set(tag("sequence_pattern", choice!(
    ...
    group_pattern.set(tag("group_pattern", seq!(
        python_literal("("),
         opt(&WS),
         &pattern,
         opt(&WS),
    ...
    name_or_attr.set(tag("name_or_attr", seq!(&NAME, opt(seq!(opt(&WS), python_literal("."), opt(&WS), &NAME, opt(repeat1(seq!(opt(&WS), python_literal("."), opt(&WS), &NAME))))))));
    attr.set(tag("attr", seq!(
        &name_or_attr,
         opt(&WS),
         python_literal("."),
         opt(&WS),
    ...
    value_pattern.set(tag("value_pattern", seq!(&attr, negative_lookahead(choice!(python_literal("."), python_literal("("), python_literal("="))))));
    wildcard_pattern.set(tag("wildcard_pattern", python_literal("_")));
    pattern_capture_target.set(tag("pattern_capture_target", seq!(negative_lookahead(python_literal("_")), &NAME, negative_lookahead(choice!(python_literal("."), python_literal("("), python_literal("="))))));
    capture_pattern.set(tag("capture_pattern", &pattern_capture_target));
    imaginary_number.set(tag("imaginary_number", &NUMBER));
    real_number.set(tag("real_number", &NUMBER));
    signed_real_number.set(tag("signed_real_number", choice!(
        &real_number,
        seq!(python_literal("-"), opt(&WS), &real_number)
    )));
    signed_number.set(tag("signed_number", choice!(
        &NUMBER,
        seq!(python_literal("-"), opt(&WS), &NUMBER)
    )));
    complex_number.set(tag("complex_number", seq!(&signed_real_number, opt(&WS), choice!(seq!(python_literal("+"), opt(&WS), &imaginary_number), seq!(python_literal("-"), opt(&WS), &imaginary_number)))));
    literal_expr.set(tag("literal_expr", choice!(
    ...
    literal_pattern.set(tag("literal_pattern", choice!(
        seq!(&signed_number, negative_lookahead(choice!(python_literal("+"), python_literal("-")))),
        &complex_number,
        &strings,
        python_literal("None"),
    ...
    closed_pattern.set(cached(tag("closed_pattern", choice!(
        &literal_pattern,
        &capture_pattern,
        &wildcard_pattern,
        &value_pattern,
    ...
    or_pattern.set(tag("or_pattern", seq!(&closed_pattern, opt(seq!(opt(&WS), python_literal("|"), opt(&WS), &closed_pattern, opt(repeat1(seq!(opt(&WS), python_literal("|"), opt(&WS), &closed_pattern))))))));
    as_pattern.set(tag("as_pattern", seq!(
        &or_pattern,
         opt(&WS),
         python_literal("as"),
         opt(&WS),
    ...
    pattern.set(tag("pattern", choice!(
        &as_pattern,
        &or_pattern
    )));
    patterns.set(tag("patterns", choice!(
        &open_sequence_pattern,
        &pattern
    )));
    guard.set(tag("guard", seq!(python_literal("if"), opt(&WS), &named_expression)));
    case_block.set(tag("case_block", seq!(
        python_literal("case"),
         opt(&WS),
         &patterns,
    ...
    finally_block.set(tag("finally_block", seq!(
    ...
    except_star_block.set(tag("except_star_block", seq!(
    ...
    except_block.set(tag("except_block", seq!(python_literal("except"), opt(&WS), choice!(seq!(&expression, opt(seq!(opt(&WS), python_literal("as"), opt(&WS), &NAME)), opt(&WS), python_literal(":"), opt(&WS), &block), seq!(python_literal(":"), opt(&WS), &block)))));
    try_stmt.set(tag("try_stmt", seq!(
        python_literal("try"),
         opt(&WS),
         python_literal(":"),
         opt(&WS),
    ...
    with_item.set(tag("with_item", seq!(&expression, opt(seq!(opt(&WS), python_literal("as"), opt(&WS), &star_target, lookahead(choice!(python_literal(","), python_literal(")"), python_literal(":"))))))));
    with_stmt.set(tag("with_stmt", choice!(
    ...
    for_stmt.set(tag("for_stmt", choice!(
    ...
    while_stmt.set(tag("while_stmt", seq!(
    ...
    else_block.set(tag("else_block", seq!(
        python_literal("else"),
         opt(&WS),
         python_literal(":"),
         opt(&WS),
    ...
    elif_stmt.set(tag("elif_stmt", seq!(
        python_literal("elif"),
         opt(&WS),
         &named_expression,
         opt(&WS),
    ...
    default.set(tag("default", seq!(python_literal("="), opt(&WS), &expression)));
    star_annotation.set(tag("star_annotation", seq!(python_literal(":"), opt(&WS), &star_expression)));
    annotation.set(tag("annotation", seq!(python_literal(":"), opt(&WS), &expression)));
    param_star_annotation.set(tag("param_star_annotation", seq!(&NAME, opt(&WS), &star_annotation)));
    param.set(tag("param", seq!(&NAME, opt(seq!(opt(&WS), &annotation)))));
    param_maybe_default.set(tag("param_maybe_default", seq!(&param, opt(seq!(opt(&WS), &default)), choice!(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &TYPE_COMMENT))), seq!(opt(seq!(opt(&WS), &TYPE_COMMENT)), lookahead(python_literal(")")))))));
    param_with_default.set(tag("param_with_default", seq!(&param, opt(&WS), &default, choice!(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &TYPE_COMMENT))), seq!(opt(seq!(opt(&WS), &TYPE_COMMENT)), lookahead(python_literal(")")))))));
    param_no_default_star_annotation.set(tag("param_no_default_star_annotation", seq!(&param_star_annotation, choice!(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &TYPE_COMMENT))), seq!(opt(seq!(opt(&WS), &TYPE_COMMENT)), lookahead(python_literal(")")))))));
    param_no_default.set(tag("param_no_default", seq!(&param, choice!(seq!(opt(&WS), python_literal(","), opt(seq!(opt(&WS), &TYPE_COMMENT))), seq!(opt(seq!(opt(&WS), &TYPE_COMMENT)), lookahead(python_literal(")")))))));
    kwds.set(tag("kwds", seq!(python_literal("**"), opt(&WS), &param_no_default)));
    star_etc.set(tag("star_etc", choice!(
    ...
    slash_with_default.set(tag("slash_with_default", seq!(
    ...
    slash_no_default.set(tag("slash_no_default", seq!(
        &param_no_default,
    ...
    parameters.set(tag("parameters", choice!(
    ...
    params.set(tag("params", &parameters));
    function_def_raw.set(tag("function_def_raw", choice!(
    ...
    function_def.set(tag("function_def", choice!(
    ...
    class_def_raw.set(tag("class_def_raw", seq!(
    ...
    class_def.set(tag("class_def", choice!(
    ...
    decorators.set(tag("decorators", seq!(
        python_literal("@"),
         opt(&WS),
         &named_expression,
         opt(&WS),
    ...
    block.set(cached(tag("block", choice!(
    ...
    dotted_name.set(tag("dotted_name", seq!(&NAME, opt(seq!(opt(&WS), python_literal("."), opt(&WS), &NAME, opt(repeat1(seq!(opt(&WS), python_literal("."), opt(&WS), &NAME))))))));
    dotted_as_name.set(tag("dotted_as_name", seq!(&dotted_name, opt(seq!(opt(&WS), python_literal("as"), opt(&WS), &NAME)))));
    dotted_as_names.set(tag("dotted_as_names", seq!(&dotted_as_name, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &dotted_as_name, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &dotted_as_name))))))));
    import_from_as_name.set(tag("import_from_as_name", seq!(&NAME, opt(seq!(opt(&WS), python_literal("as"), opt(&WS), &NAME)))));
    import_from_as_names.set(tag("import_from_as_names", seq!(&import_from_as_name, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &import_from_as_name, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &import_from_as_name))))))));
    import_from_targets.set(tag("import_from_targets", choice!(
    ...
    import_from.set(tag("import_from", seq!(python_literal("from"), opt(&WS), choice!(seq!(opt(seq!(choice!(python_literal("."), python_literal("...")), opt(repeat1(seq!(opt(&WS), choice!(python_literal("."), python_literal("..."))))), opt(&WS))), &dotted_name, opt(&WS), python_literal("import"), opt(&WS), &import_from_targets), seq!(choice!(python_literal("."), python_literal("...")), opt(repeat1(seq!(opt(&WS), choice!(python_literal("."), python_literal("..."))))), opt(&WS), python_literal("import"), opt(&WS), &import_from_targets)))));
    import_name.set(tag("import_name", seq!(python_literal("import"), opt(&WS), &dotted_as_names)));
    import_stmt.set(tag("import_stmt", choice!(
        &import_name,
        &import_from
    )));
    assert_stmt.set(tag("assert_stmt", seq!(python_literal("assert"), opt(&WS), &expression, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &expression)))));
    yield_stmt.set(tag("yield_stmt", &yield_expr));
    del_stmt.set(tag("del_stmt", seq!(python_literal("del"), opt(&WS), &del_targets, lookahead(choice!(python_literal(";"), &NEWLINE)))));
    nonlocal_stmt.set(tag("nonlocal_stmt", seq!(python_literal("nonlocal"), opt(&WS), &NAME, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &NAME, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &NAME))))))));
    global_stmt.set(tag("global_stmt", seq!(python_literal("global"), opt(&WS), &NAME, opt(seq!(opt(&WS), python_literal(","), opt(&WS), &NAME, opt(repeat1(seq!(opt(&WS), python_literal(","), opt(&WS), &NAME))))))));
    raise_stmt.set(tag("raise_stmt", seq!(python_literal("raise"), opt(seq!(opt(&WS), &expression, opt(seq!(opt(&WS), python_literal("from"), opt(&WS), &expression)))))));
    return_stmt.set(tag("return_stmt", seq!(python_literal("return"), opt(seq!(opt(&WS), &star_expressions)))));
    augassign.set(tag("augassign", choice!(
        python_literal("+="),
        python_literal("-="),
        python_literal("*="),
        python_literal("@="),
    ...
    annotated_rhs.set(tag("annotated_rhs", choice!(
        &yield_expr,
        &star_expressions
    )));
    assignment.set(tag("assignment", choice!(
    ...
    compound_stmt.set(tag("compound_stmt", choice!(
    ...
    simple_stmt.set(cached(tag("simple_stmt", choice!(
        &assignment,
    ...
    simple_stmts.set(tag("simple_stmts", seq!(&simple_stmt, opt(&WS), choice!(seq!(negative_lookahead(python_literal(";")), &NEWLINE), seq!(opt(seq!(python_literal(";"), opt(&WS), &simple_stmt, opt(repeat1(seq!(opt(&WS), python_literal(";"), opt(&WS), &simple_stmt))), opt(&WS))), opt(seq!(python_literal(";"), opt(&WS))), &NEWLINE)))));
    statement_newline.set(tag("statement_newline", choice!(
        seq!(&compound_stmt, opt(&WS), &NEWLINE),
        &simple_stmts,
        &NEWLINE,
        &ENDMARKER
    )));
    statement.set(tag("statement", choice!(
        &compound_stmt,
        &simple_stmts
    )));
    statements.set(tag("statements", seq!(&statement, opt(repeat1(seq!(opt(&WS), &statement))))));
    func_type.set(tag("func_type", seq!(
        python_literal("("),
    ...
    eval.set(tag("eval", seq!(&expressions, opt(seq!(opt(&WS), &NEWLINE, opt(repeat1(seq!(opt(&WS), &NEWLINE))))), opt(&WS), &ENDMARKER)));
    interactive.set(tag("interactive", &statement_newline));
    file.set(tag("file", seq!(opt(seq!(&statements, opt(&WS))), &ENDMARKER)));
