...
pub fn del_target() -> impl CombinatorTrait {
    cached(tag("del_target", choice!(
        seq!(choice!(NAME(), python_literal("True"), python_literal("False"), python_literal("None"), seq!(lookahead(choice!(STRING(), FSTRING_START())), deferred_dyn(strings)), NUMBER(), seq!(lookahead(python_literal("(")), choice!(deferred_dyn(tuple), deferred_dyn(group), deferred_dyn(genexp))), seq!(lookahead(python_literal("[")), choice!(deferred_dyn(list), deferred_dyn(listcomp))), seq!(lookahead(python_literal("{")), choice!(deferred_dyn(dict), deferred_dyn(set), deferred_dyn(dictcomp), deferred_dyn(setcomp))), python_literal("...")), lookahead(deferred_dyn(t_lookahead)), repeat0(choice!(seq!(python_literal("."), NAME(), lookahead(deferred_dyn(t_lookahead))), seq!(python_literal("["), choice!(seq!(deferred_dyn(slice), negative_lookahead(python_literal(","))), seq!(seprep1(choice!(deferred_dyn(slice), deferred_dyn(starred_expression)), python_literal(",")), opt(python_literal(",")))), python_literal("]"), lookahead(deferred_dyn(t_lookahead))), seq!(python_literal("("), choice!(seq!(choice!(seq!(NAME(), python_literal(":="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef))), seq!(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef)), negative_lookahead(python_literal(":=")))), repeat1(deferred_dyn(for_if_clause)), python_literal(")"), lookahead(deferred_dyn(t_lookahead))), seq!(opt(seq!(deferred_dyn(args), opt(python_literal(",")), lookahead(python_literal(")")))), python_literal(")"), lookahead(deferred_dyn(t_lookahead))))))), choice!(seq!(python_literal("."), NAME(), negative_lookahead(deferred_dyn(t_lookahead))), seq!(python_literal("["), choice!(seq!(deferred_dyn(slice), negative_lookahead(python_literal(","))), seq!(seprep1(choice!(deferred_dyn(slice), deferred_dyn(starred_expression)), python_literal(",")), opt(python_literal(",")))), python_literal("]"), negative_lookahead(deferred_dyn(t_lookahead))))),
        del_t_atom()
    )))
}
...
pub fn t_primary() -> impl CombinatorTrait {
    tag("t_primary", seq!(choice!(NAME(), python_literal("True"), python_literal("False"), python_literal("None"), seq!(lookahead(choice!(STRING(), FSTRING_START())), deferred_dyn(strings)), NUMBER(), seq!(lookahead(python_literal("(")), choice!(deferred_dyn(tuple), deferred_dyn(group), deferred_dyn(genexp))), seq!(lookahead(python_literal("[")), choice!(deferred_dyn(list), deferred_dyn(listcomp))), seq!(lookahead(python_literal("{")), choice!(deferred_dyn(dict), deferred_dyn(set), deferred_dyn(dictcomp), deferred_dyn(setcomp))), python_literal("...")), lookahead(t_lookahead()), repeat0(choice!(seq!(python_literal("."), NAME(), lookahead(t_lookahead())), seq!(python_literal("["), choice!(seq!(deferred_dyn(slice), negative_lookahead(python_literal(","))), seq!(seprep1(choice!(deferred_dyn(slice), deferred_dyn(starred_expression)), python_literal(",")), opt(python_literal(",")))), python_literal("]"), lookahead(t_lookahead())), seq!(python_literal("("), choice!(seq!(choice!(seq!(NAME(), python_literal(":="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef))), seq!(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef)), negative_lookahead(python_literal(":=")))), repeat1(deferred_dyn(for_if_clause)), python_literal(")"), lookahead(t_lookahead())), seq!(opt(seq!(deferred_dyn(args), opt(python_literal(",")), lookahead(python_literal(")")))), python_literal(")"), lookahead(t_lookahead()))))))))
}

pub fn single_subscript_attribute_target() -> impl CombinatorTrait {
    tag("single_subscript_attribute_target", seq!(t_primary(), choice!(seq!(python_literal("."), NAME(), negative_lookahead(t_lookahead())), seq!(python_literal("["), choice!(seq!(deferred_dyn(slice), negative_lookahead(python_literal(","))), seq!(seprep1(choice!(deferred_dyn(slice), deferred_dyn(starred_expression)), python_literal(",")), opt(python_literal(",")))), python_literal("]"), negative_lookahead(t_lookahead())))))
}
...
pub fn star_atom() -> impl CombinatorTrait {
    tag("star_atom", choice!(
        NAME(),
        seq!(python_literal("("), choice!(seq!(choice!(seq!(t_primary(), choice!(seq!(python_literal("."), NAME(), negative_lookahead(t_lookahead())), seq!(python_literal("["), choice!(seq!(deferred_dyn(slice), negative_lookahead(python_literal(","))), seq!(seprep1(choice!(deferred_dyn(slice), deferred_dyn(starred_expression)), python_literal(",")), opt(python_literal(",")))), python_literal("]"), negative_lookahead(t_lookahead())))), deferred_dyn(star_atom)), python_literal(")")), seq!(opt(seq!(deferred_dyn(star_target), choice!(seq!(repeat1(seq!(python_literal(","), deferred_dyn(star_target))), opt(python_literal(","))), python_literal(",")))), python_literal(")")))),
...
pub fn kwarg_or_double_starred() -> impl CombinatorTrait {
    tag("kwarg_or_double_starred", choice!(
        seq!(NAME(), python_literal("="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef))),
        seq!(python_literal("**"), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef)))
    ))
}
...
pub fn args() -> impl CombinatorTrait {
    tag("args", choice!(
        seq!(seprep1(choice!(starred_expression(), seq!(choice!(seq!(NAME(), python_literal(":="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef))), seq!(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef)), negative_lookahead(python_literal(":=")))), negative_lookahead(python_literal("=")))), python_literal(",")), opt(seq!(python_literal(","), kwargs()))),
        kwargs()
    ))
}
...
pub fn genexp() -> impl CombinatorTrait {
    tag("genexp", seq!(python_literal("("), choice!(seq!(NAME(), python_literal(":="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef))), seq!(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef)), negative_lookahead(python_literal(":=")))), repeat1(deferred_dyn(for_if_clause)), python_literal(")")))
}

pub fn setcomp() -> impl CombinatorTrait {
    tag("setcomp", seq!(python_literal("{"), choice!(seq!(NAME(), python_literal(":="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef))), seq!(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef)), negative_lookahead(python_literal(":=")))), repeat1(deferred_dyn(for_if_clause)), python_literal("}")))
}

pub fn listcomp() -> impl CombinatorTrait {
    tag("listcomp", seq!(python_literal("["), choice!(seq!(NAME(), python_literal(":="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef))), seq!(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef)), negative_lookahead(python_literal(":=")))), repeat1(deferred_dyn(for_if_clause)), python_literal("]")))
}

pub fn for_if_clause() -> impl CombinatorTrait {
    tag("for_if_clause", choice!(
        seq!(python_literal("async"), python_literal("for"), star_targets(), python_literal("in"), deferred_dyn(conjunction), repeat0(seq!(python_literal("or"), deferred_dyn(conjunction))), repeat0(seq!(python_literal("if"), deferred_dyn(conjunction), repeat0(seq!(python_literal("or"), deferred_dyn(conjunction)))))),
        seq!(python_literal("for"), star_targets(), python_literal("in"), deferred_dyn(conjunction), repeat0(seq!(python_literal("or"), deferred_dyn(conjunction))), repeat0(seq!(python_literal("if"), deferred_dyn(conjunction), repeat0(seq!(python_literal("or"), deferred_dyn(conjunction))))))
    ))
}
...
pub fn strings() -> impl CombinatorTrait {
    cached(tag("strings", repeat1(choice!(seq!(FSTRING_START(), opt(seq!(choice!(deferred_dyn(fstring_replacement_field), FSTRING_MIDDLE()), repeat0(deferred_dyn(fstring_middle)))), FSTRING_END()), STRING()))))
}
...
pub fn fstring() -> impl CombinatorTrait {
    tag("fstring", seq!(FSTRING_START(), opt(seq!(choice!(deferred_dyn(fstring_replacement_field), FSTRING_MIDDLE()), repeat0(deferred_dyn(fstring_middle)))), FSTRING_END()))
}
...
pub fn lambda_param_maybe_default() -> impl CombinatorTrait {
    tag("lambda_param_maybe_default", seq!(lambda_param(), opt(seq!(python_literal("="), deferred_dyn(expression))), choice!(python_literal(","), lookahead(python_literal(":")))))
}

pub fn lambda_param_with_default() -> impl CombinatorTrait {
    tag("lambda_param_with_default", seq!(lambda_param(), python_literal("="), deferred_dyn(expression), choice!(python_literal(","), lookahead(python_literal(":")))))
}
...
pub fn lambdef() -> impl CombinatorTrait {
    tag("lambdef", seq!(python_literal("lambda"), opt(lambda_params()), python_literal(":"), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), deferred_dyn(lambdef))))
}

pub fn group() -> impl CombinatorTrait {
    tag("group", seq!(python_literal("("), choice!(seq!(python_literal("yield"), choice!(seq!(python_literal("from"), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), lambdef())), opt(deferred_dyn(star_expressions)))), choice!(seq!(NAME(), python_literal(":="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), lambdef())), seq!(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), lambdef()), negative_lookahead(python_literal(":="))))), python_literal(")")))
}
...
pub fn slice() -> impl CombinatorTrait {
    tag("slice", choice!(
        seq!(opt(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), lambdef())), python_literal(":"), opt(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), lambdef())), opt(seq!(python_literal(":"), opt(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), lambdef()))))),
        choice!(seq!(NAME(), python_literal(":="), choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), lambdef())), seq!(choice!(seq!(deferred_dyn(disjunction), opt(seq!(python_literal("if"), deferred_dyn(disjunction), python_literal("else"), deferred_dyn(expression)))), lambdef()), negative_lookahead(python_literal(":="))))
    ))
}
...
pub fn power() -> impl CombinatorTrait {
    tag("power", seq!(await_primary(), opt(seq!(python_literal("**"), choice!(seq!(python_literal("+"), deferred_dyn(factor)), seq!(python_literal("-"), deferred_dyn(factor)), seq!(python_literal("~"), deferred_dyn(factor)), deferred_dyn(power))))))
}
...
pub fn named_expression() -> impl CombinatorTrait {
    tag("named_expression", choice!(
        seq!(NAME(), python_literal(":="), choice!(seq!(disjunction(), opt(seq!(python_literal("if"), disjunction(), python_literal("else"), deferred_dyn(expression)))), lambdef())),
        seq!(choice!(seq!(disjunction(), opt(seq!(python_literal("if"), disjunction(), python_literal("else"), deferred_dyn(expression)))), lambdef()), negative_lookahead(python_literal(":=")))
    ))
}

pub fn assignment_expression() -> impl CombinatorTrait {
    tag("assignment_expression", seq!(NAME(), python_literal(":="), choice!(seq!(disjunction(), opt(seq!(python_literal("if"), disjunction(), python_literal("else"), deferred_dyn(expression)))), lambdef())))
}
...
pub fn star_expression() -> impl CombinatorTrait {
    cached(tag("star_expression", choice!(
        seq!(python_literal("*"), bitwise_or()),
        choice!(seq!(disjunction(), opt(seq!(python_literal("if"), disjunction(), python_literal("else"), deferred_dyn(expression)))), lambdef())
    )))
}
...
pub fn yield_expr() -> impl CombinatorTrait {
    tag("yield_expr", seq!(python_literal("yield"), choice!(seq!(python_literal("from"), choice!(seq!(disjunction(), opt(seq!(python_literal("if"), disjunction(), python_literal("else"), deferred_dyn(expression)))), lambdef())), opt(star_expressions()))))
}

pub fn expression() -> impl CombinatorTrait {
    cached(tag("expression", choice!(
        seq!(disjunction(), opt(seq!(python_literal("if"), disjunction(), python_literal("else"), deferred_dyn(expression)))),
        lambdef()
    )))
}
...
pub fn keyword_pattern() -> impl CombinatorTrait {
    tag("keyword_pattern", seq!(NAME(), python_literal("="), choice!(deferred_dyn(as_pattern), deferred_dyn(or_pattern))))
}
...
pub fn key_value_pattern() -> impl CombinatorTrait {
    tag("key_value_pattern", seq!(choice!(choice!(seq!(deferred_dyn(signed_number), negative_lookahead(choice!(python_literal("+"), python_literal("-")))), deferred_dyn(complex_number), strings(), python_literal("None"), python_literal("True"), python_literal("False")), seq!(deferred_dyn(name_or_attr), python_literal("."), NAME())), python_literal(":"), choice!(deferred_dyn(as_pattern), deferred_dyn(or_pattern))))
}
...
pub fn case_block() -> impl CombinatorTrait {
    tag("case_block", seq!(
        python_literal("case"),
         ...
         opt(guard()),
         python_literal(":"),
         choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))
    ))
}
...
pub fn finally_block() -> impl CombinatorTrait {
    tag("finally_block", seq!(python_literal("finally"), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))))
}
...
pub fn except_block() -> impl CombinatorTrait {
    tag("except_block", seq!(python_literal("except"), choice!(seq!(expression(), opt(seq!(python_literal("as"), NAME())), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))), seq!(python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))))))
}

pub fn try_stmt() -> impl CombinatorTrait {
    tag("try_stmt", seq!(python_literal("try"), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))), choice!(finally_block(), seq!(repeat1(except_block()), opt(seq!(python_literal("else"), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))))), opt(finally_block())), seq!(repeat1(except_star_block()), opt(seq!(python_literal("else"), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))))), opt(finally_block())))))
}
...
pub fn with_stmt() -> impl CombinatorTrait {
    tag("with_stmt", choice!(
        seq!(python_literal("with"), choice!(seq!(python_literal("("), seprep1(with_item(), python_literal(",")), opt(python_literal(",")), python_literal(")"), python_literal(":"), opt(TYPE_COMMENT()), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))), seq!(seprep1(with_item(), python_literal(",")), python_literal(":"), opt(TYPE_COMMENT()), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))))),
        seq!(python_literal("async"), python_literal("with"), choice!(seq!(python_literal("("), seprep1(with_item(), python_literal(",")), opt(python_literal(",")), python_literal(")"), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))), seq!(seprep1(with_item(), python_literal(",")), python_literal(":"), opt(TYPE_COMMENT()), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))))))
    ))
}

pub fn for_stmt() -> impl CombinatorTrait {
    tag("for_stmt", choice!(
        seq!(python_literal("for"), star_targets(), python_literal("in"), star_expressions(), python_literal(":"), opt(TYPE_COMMENT()), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))), opt(seq!(python_literal("else"), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))))),
...
pub fn while_stmt() -> impl CombinatorTrait {
    tag("while_stmt", seq!(
        python_literal("while"),
         ...
         python_literal(":"),
         choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))),
         opt(seq!(python_literal("else"), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))))
    ))
}

pub fn else_block() -> impl CombinatorTrait {
    tag("else_block", seq!(python_literal("else"), python_literal(":"), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))))
}
...
pub fn elif_stmt() -> impl CombinatorTrait {
    tag("elif_stmt", seq!(
        python_literal("elif"),
         ...
         python_literal(":"),
         choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))),
         choice!(deferred_dyn(elif_stmt), opt(else_block()))
    ))
}
...
pub fn function_def_raw() -> impl CombinatorTrait {
    tag("function_def_raw", choice!(
        seq!(python_literal("def"), NAME(), opt(type_params()), python_literal("("), opt(params()), python_literal(")"), opt(seq!(python_literal("->"), expression())), python_literal(":"), opt(func_type_comment()), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE())))),
        seq!(python_literal("async"), python_literal("def"), NAME(), opt(type_params()), python_literal("("), opt(params()), python_literal(")"), opt(seq!(python_literal("->"), expression())), python_literal(":"), opt(func_type_comment()), choice!(seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()), choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))))
    ))
}
...
pub fn block() -> impl CombinatorTrait {
    cached(tag("block", choice!(
        seq!(NEWLINE(), INDENT(), repeat1(deferred_dyn(statement)), DEDENT()),
        choice!(seq!(deferred_dyn(simple_stmt), negative_lookahead(python_literal(";")), NEWLINE()), seq!(seprep1(deferred_dyn(simple_stmt), python_literal(";")), opt(python_literal(";")), NEWLINE()))
    )))
}
