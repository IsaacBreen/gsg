...
fn func_type_comment() -> Combinator {
    tag("func_type_comment", choice!(
        seq!(deferred(NEWLINE), opt(deferred(WS)), deferred(TYPE_COMMENT), lookahead(seq!(opt(deferred(WS)), deferred(NEWLINE), opt(deferred(WS)), deferred(INDENT)))),
...
fn del_target() -> Combinator {
    cached(tag("del_target", choice!(
        seq!(choice!(deferred(NAME), python_literal("True"), python_literal("False"), python_literal("None"), seq!(lookahead(seq!(choice!(deferred(STRING), deferred(FSTRING_START)), opt(deferred(WS)))), deferred(strings)), deferred(NUMBER), seq!(lookahead(seq!(python_literal("("), opt(deferred(WS)))), choice!(deferred(tuple), deferred(group), deferred(genexp))), seq!(lookahead(seq!(python_literal("["), opt(deferred(WS)))), choice!(deferred(list), deferred(listcomp))), seq!(lookahead(seq!(python_literal("{"), opt(deferred(WS)))), choice!(deferred(dict), deferred(set), deferred(dictcomp), deferred(setcomp))), python_literal("...")), lookahead(seq!(opt(deferred(WS)), deferred(t_lookahead))), opt(seq!(opt(deferred(WS)), choice!(seq!(python_literal("."), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(NAME), lookahead(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(python_literal("["), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(slices), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), python_literal("]"), lookahead(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(deferred(genexp), lookahead(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(python_literal("("), opt(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(arguments))), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), python_literal(")"), lookahead(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead))))), opt(repeat1(seq!(opt(deferred(WS)), choice!(seq!(python_literal("."), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(NAME), lookahead(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(python_literal("["), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(slices), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), python_literal("]"), lookahead(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(deferred(genexp), lookahead(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(python_literal("("), opt(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(arguments))), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), python_literal(")"), lookahead(seq!(opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))))))))), opt(deferred(WS)), choice!(seq!(python_literal("."), opt(deferred(WS)), deferred(NAME), negative_lookahead(seq!(opt(deferred(WS)), deferred(t_lookahead)))), seq!(python_literal("["), opt(deferred(WS)), deferred(slices), opt(deferred(WS)), python_literal("]"), negative_lookahead(seq!(opt(deferred(WS)), deferred(t_lookahead)))))),
        deferred(del_t_atom)
    ))).into()
}
...
fn t_primary() -> Combinator {
    tag("t_primary", seq!(choice!(deferred(NAME), python_literal("True"), python_literal("False"), python_literal("None"), seq!(lookahead(seq!(choice!(deferred(STRING), deferred(FSTRING_START)), opt(deferred(WS)))), deferred(strings)), deferred(NUMBER), seq!(lookahead(seq!(python_literal("("), opt(deferred(WS)))), choice!(deferred(tuple), deferred(group), deferred(genexp))), seq!(lookahead(seq!(python_literal("["), opt(deferred(WS)))), choice!(deferred(list), deferred(listcomp))), seq!(lookahead(seq!(python_literal("{"), opt(deferred(WS)))), choice!(deferred(dict), deferred(set), deferred(dictcomp), deferred(setcomp))), python_literal("...")), lookahead(seq!(opt(deferred(WS)), deferred(t_lookahead))), opt(seq!(opt(deferred(WS)), choice!(seq!(python_literal("."), opt(deferred(WS)), deferred(NAME), lookahead(seq!(opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(python_literal("["), opt(deferred(WS)), deferred(slices), opt(deferred(WS)), python_literal("]"), lookahead(seq!(opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(deferred(genexp), lookahead(seq!(opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(python_literal("("), opt(seq!(opt(deferred(WS)), deferred(arguments))), opt(deferred(WS)), python_literal(")"), lookahead(seq!(opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead))))), opt(repeat1(seq!(opt(deferred(WS)), choice!(seq!(python_literal("."), opt(deferred(WS)), deferred(NAME), lookahead(seq!(opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(python_literal("["), opt(deferred(WS)), deferred(slices), opt(deferred(WS)), python_literal("]"), lookahead(seq!(opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(deferred(genexp), lookahead(seq!(opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))), seq!(python_literal("("), opt(seq!(opt(deferred(WS)), deferred(arguments))), opt(deferred(WS)), python_literal(")"), lookahead(seq!(opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(t_lookahead)))))))))))).into()
}

fn single_subscript_attribute_target() -> Combinator {
    tag("single_subscript_attribute_target", seq!(deferred(t_primary), opt(deferred(WS)), choice!(seq!(python_literal("."), opt(deferred(WS)), deferred(NAME), negative_lookahead(seq!(opt(deferred(WS)), deferred(t_lookahead)))), seq!(python_literal("["), opt(deferred(WS)), deferred(slices), opt(deferred(WS)), python_literal("]"), negative_lookahead(seq!(opt(deferred(WS)), deferred(t_lookahead))))))).into()
}
...
fn target_with_star_atom() -> Combinator {
    cached(tag("target_with_star_atom", choice!(
        seq!(deferred(t_primary), opt(deferred(WS)), choice!(seq!(python_literal("."), opt(deferred(WS)), deferred(NAME), negative_lookahead(seq!(opt(deferred(WS)), deferred(t_lookahead)))), seq!(python_literal("["), opt(deferred(WS)), deferred(slices), opt(deferred(WS)), python_literal("]"), negative_lookahead(seq!(opt(deferred(WS)), deferred(t_lookahead)))))),
        deferred(star_atom)
    ))).into()
}
...
fn star_target() -> Combinator {
    cached(tag("star_target", choice!(
        seq!(python_literal("*"), negative_lookahead(seq!(opt(deferred(WS)), python_literal("*"))), opt(deferred(WS)), deferred(star_target)),
...
fn star_targets() -> Combinator {
    tag("star_targets", seq!(deferred(star_target), choice!(negative_lookahead(seq!(opt(deferred(WS)), python_literal(","))), seq!(opt(seq!(opt(deferred(WS)), python_literal(","), opt(deferred(WS)), deferred(star_target), opt(repeat1(seq!(opt(deferred(WS)), python_literal(","), opt(deferred(WS)), deferred(star_target)))))), opt(seq!(opt(deferred(WS)), python_literal(","))))))).into()
}
...
fn args() -> Combinator {
    tag("args", choice!(
        seq!(choice!(deferred(starred_expression), seq!(choice!(seq!(deferred(NAME), opt(deferred(WS)), python_literal(":="), opt(deferred(WS)), deferred(expression)), seq!(choice!(seq!(deferred(disjunction), opt(seq!(opt(deferred(WS)), python_literal("if"), opt(deferred(WS)), deferred(disjunction), opt(deferred(WS)), python_literal("else"), opt(deferred(WS)), deferred(expression)))), deferred(lambdef)), negative_lookahead(seq!(opt(deferred(WS)), python_literal(":="))))), negative_lookahead(seq!(opt(deferred(WS)), python_literal("="))))), opt(seq!(opt(deferred(WS)), python_literal(","), opt(deferred(WS)), choice!(deferred(starred_expression), seq!(choice!(seq!(deferred(NAME), opt(deferred(WS)), python_literal(":="), opt(deferred(WS)), deferred(expression)), seq!(choice!(seq!(deferred(disjunction), opt(seq!(opt(deferred(WS)), python_literal("if"), opt(deferred(WS)), deferred(disjunction), opt(deferred(WS)), python_literal("else"), opt(deferred(WS)), deferred(expression)))), deferred(lambdef)), negative_lookahead(seq!(opt(deferred(WS)), python_literal(":="))))), negative_lookahead(seq!(opt(deferred(WS)), python_literal("="))))), opt(repeat1(seq!(opt(deferred(WS)), python_literal(","), opt(deferred(WS)), choice!(deferred(starred_expression), seq!(choice!(seq!(deferred(NAME), opt(deferred(WS)), python_literal(":="), opt(deferred(WS)), deferred(expression)), seq!(choice!(seq!(deferred(disjunction), opt(seq!(opt(deferred(WS)), python_literal("if"), opt(deferred(WS)), deferred(disjunction), opt(deferred(WS)), python_literal("else"), opt(deferred(WS)), deferred(expression)))), deferred(lambdef)), negative_lookahead(seq!(opt(deferred(WS)), python_literal(":="))))), negative_lookahead(seq!(opt(deferred(WS)), python_literal("=")))))))))), opt(seq!(opt(deferred(WS)), python_literal(","), opt(deferred(WS)), deferred(kwargs)))),
        deferred(kwargs)
    )).into()
}

fn arguments() -> Combinator {
    cached(tag("arguments", seq!(deferred(args), opt(seq!(opt(deferred(WS)), python_literal(","))), lookahead(seq!(opt(deferred(WS)), python_literal(")")))))).into()
}
...
fn genexp() -> Combinator {
    tag("genexp", seq!(
        python_literal("("),
         opt(deferred(WS)),
         choice!(deferred(assignment_expression), seq!(deferred(expression), negative_lookahead(seq!(opt(deferred(WS)), python_literal(":="))))),
         opt(deferred(WS)),
         deferred(for_if_clauses),
         opt(deferred(WS)),
         python_literal(")")
...
fn lambda_param_maybe_default() -> Combinator {
    tag("lambda_param_maybe_default", seq!(deferred(lambda_param), opt(seq!(opt(deferred(WS)), deferred(default))), choice!(seq!(opt(deferred(WS)), python_literal(",")), lookahead(seq!(opt(deferred(WS)), python_literal(":")))))).into()
}

fn lambda_param_with_default() -> Combinator {
    tag("lambda_param_with_default", seq!(deferred(lambda_param), opt(deferred(WS)), deferred(default), choice!(seq!(opt(deferred(WS)), python_literal(",")), lookahead(seq!(opt(deferred(WS)), python_literal(":")))))).into()
}

fn lambda_param_no_default() -> Combinator {
    tag("lambda_param_no_default", seq!(deferred(lambda_param), choice!(seq!(opt(deferred(WS)), python_literal(",")), lookahead(seq!(opt(deferred(WS)), python_literal(":")))))).into()
}
...
fn lambda_slash_with_default() -> Combinator {
    tag("lambda_slash_with_default", seq!(
        opt(seq!(deferred(lambda_param_no_default), opt(repeat1(seq!(opt(deferred(WS)), deferred(lambda_param_no_default)))), opt(deferred(WS)))),
         ...
         opt(deferred(WS)),
         python_literal("/"),
         choice!(seq!(opt(deferred(WS)), python_literal(",")), lookahead(seq!(opt(deferred(WS)), python_literal(":"))))
    )).into()
}
...
fn atom() -> Combinator {
    tag("atom", choice!(
        ...
        python_literal("None"),
        seq!(lookahead(seq!(choice!(deferred(STRING), deferred(FSTRING_START)), opt(deferred(WS)))), deferred(strings)),
        deferred(NUMBER),
        seq!(lookahead(seq!(python_literal("("), opt(deferred(WS)))), choice!(deferred(tuple), deferred(group), deferred(genexp))),
        seq!(lookahead(seq!(python_literal("["), opt(deferred(WS)))), choice!(deferred(list), deferred(listcomp))),
        seq!(lookahead(seq!(python_literal("{"), opt(deferred(WS)))), choice!(deferred(dict), deferred(set), deferred(dictcomp), deferred(setcomp))),
        python_literal("...")
    )).into()
}
...
fn slice() -> Combinator {
    tag("slice", choice!(
        seq!(opt(seq!(choice!(seq!(deferred(disjunction), opt(seq!(opt(deferred(WS)), python_literal("if"), opt(deferred(WS)), deferred(disjunction), opt(deferred(WS)), python_literal("else"), opt(deferred(WS)), deferred(expression)))), deferred(lambdef)), opt(deferred(WS)))), python_literal(":"), opt(seq!(opt(deferred(WS)), deferred(expression))), opt(seq!(opt(deferred(WS)), python_literal(":"), opt(seq!(opt(deferred(WS)), deferred(expression)))))),
        choice!(seq!(deferred(NAME), opt(deferred(WS)), python_literal(":="), opt(deferred(WS)), deferred(expression)), seq!(choice!(seq!(deferred(disjunction), opt(seq!(opt(deferred(WS)), python_literal("if"), opt(deferred(WS)), deferred(disjunction), opt(deferred(WS)), python_literal("else"), opt(deferred(WS)), deferred(expression)))), deferred(lambdef)), negative_lookahead(seq!(opt(deferred(WS)), python_literal(":=")))))
    )).into()
}

fn slices() -> Combinator {
    tag("slices", choice!(
        seq!(deferred(slice), negative_lookahead(seq!(opt(deferred(WS)), python_literal(",")))),
...
fn named_expression() -> Combinator {
    tag("named_expression", choice!(
        seq!(deferred(NAME), opt(deferred(WS)), python_literal(":="), opt(deferred(WS)), deferred(expression)),
        seq!(choice!(seq!(deferred(disjunction), opt(seq!(opt(deferred(WS)), python_literal("if"), opt(deferred(WS)), deferred(disjunction), opt(deferred(WS)), python_literal("else"), opt(deferred(WS)), deferred(expression)))), deferred(lambdef)), negative_lookahead(seq!(opt(deferred(WS)), python_literal(":="))))
    )).into()
}
...
fn yield_expr() -> Combinator {
    tag("yield_expr", seq!(python_literal("yield"), choice!(seq!(opt(deferred(WS)), python_literal("from"), opt(deferred(WS)), deferred(expression)), opt(seq!(opt(deferred(WS)), deferred(star_expressions)))))).into()
}
...
fn key_value_pattern() -> Combinator {
    tag("key_value_pattern", seq!(
        choice!(choice!(seq!(deferred(signed_number), negative_lookahead(seq!(opt(deferred(WS)), choice!(python_literal("+"), python_literal("-"))))), deferred(complex_number), deferred(strings), python_literal("None"), python_literal("True"), python_literal("False")), seq!(deferred(name_or_attr), opt(deferred(WS)), python_literal("."), opt(deferred(WS)), deferred(NAME))),
         opt(deferred(WS)),
         python_literal(":"),
         opt(deferred(WS)),
         deferred(pattern)
...
fn value_pattern() -> Combinator {
    tag("value_pattern", seq!(deferred(attr), negative_lookahead(seq!(opt(deferred(WS)), choice!(python_literal("."), python_literal("("), python_literal("=")))))).into()
}
...
fn pattern_capture_target() -> Combinator {
    tag("pattern_capture_target", seq!(negative_lookahead(seq!(python_literal("_"), opt(deferred(WS)))), deferred(NAME), negative_lookahead(seq!(opt(deferred(WS)), choice!(python_literal("."), python_literal("("), python_literal("=")))))).into()
}
...
fn literal_expr() -> Combinator {
    tag("literal_expr", choice!(
        seq!(deferred(signed_number), negative_lookahead(seq!(opt(deferred(WS)), choice!(python_literal("+"), python_literal("-"))))),
...
fn with_item() -> Combinator {
    tag("with_item", seq!(deferred(expression), opt(seq!(opt(deferred(WS)), python_literal("as"), opt(deferred(WS)), deferred(star_target), lookahead(seq!(opt(deferred(WS)), choice!(python_literal(","), python_literal(")"), python_literal(":")))))))).into()
}
...
fn elif_stmt() -> Combinator {
    tag("elif_stmt", seq!(
        python_literal("elif"),
         ...
         opt(deferred(WS)),
         deferred(block),
         choice!(seq!(opt(deferred(WS)), deferred(elif_stmt)), opt(seq!(opt(deferred(WS)), deferred(else_block))))
    )).into()
}
...
fn param_maybe_default() -> Combinator {
    tag("param_maybe_default", seq!(deferred(param), opt(seq!(opt(deferred(WS)), deferred(default))), choice!(seq!(opt(deferred(WS)), python_literal(","), opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT)))), seq!(opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT))), lookahead(seq!(opt(deferred(WS)), python_literal(")"))))))).into()
}

fn param_with_default() -> Combinator {
    tag("param_with_default", seq!(deferred(param), opt(deferred(WS)), deferred(default), choice!(seq!(opt(deferred(WS)), python_literal(","), opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT)))), seq!(opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT))), lookahead(seq!(opt(deferred(WS)), python_literal(")"))))))).into()
}

fn param_no_default_star_annotation() -> Combinator {
    tag("param_no_default_star_annotation", seq!(deferred(param_star_annotation), choice!(seq!(opt(deferred(WS)), python_literal(","), opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT)))), seq!(opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT))), lookahead(seq!(opt(deferred(WS)), python_literal(")"))))))).into()
}

fn param_no_default() -> Combinator {
    tag("param_no_default", seq!(deferred(param), choice!(seq!(opt(deferred(WS)), python_literal(","), opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT)))), seq!(opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT))), lookahead(seq!(opt(deferred(WS)), python_literal(")"))))))).into()
}
...
fn block() -> Combinator {
    cached(tag("block", choice!(
        ...
        seq!(deferred(simple_stmt), opt(deferred(WS)), choice!(seq!(negative_lookahead(seq!(python_literal(";"), opt(deferred(WS)))), deferred(NEWLINE)), seq!(opt(seq!(python_literal(";"), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(simple_stmt), opt(repeat1(seq!(opt(deferred(WS)), python_literal(";"), opt(deferred(WS)), opt(seq!(deferred(WS), opt(deferred(WS)))), deferred(simple_stmt)))), opt(deferred(WS)))), opt(seq!(python_literal(";"), opt(deferred(WS)))), deferred(NEWLINE))))
    ))).into()
}
...
fn import_from_targets() -> Combinator {
    tag("import_from_targets", choice!(
        ...
        seq!(deferred(import_from_as_names), negative_lookahead(seq!(opt(deferred(WS)), python_literal(",")))),
        python_literal("*")
    )).into()
}
...
fn del_stmt() -> Combinator {
    tag("del_stmt", seq!(python_literal("del"), opt(deferred(WS)), deferred(del_targets), lookahead(seq!(opt(deferred(WS)), choice!(python_literal(";"), deferred(NEWLINE)))))).into()
}
...
fn assignment() -> Combinator {
    tag("assignment", choice!(
        ...
        seq!(deferred(star_targets), opt(deferred(WS)), python_literal("="), opt(seq!(opt(deferred(WS)), deferred(star_targets), opt(deferred(WS)), python_literal("="), opt(repeat1(seq!(opt(deferred(WS)), deferred(star_targets), opt(deferred(WS)), python_literal("=")))))), opt(deferred(WS)), choice!(deferred(yield_expr), deferred(star_expressions)), negative_lookahead(seq!(opt(deferred(WS)), python_literal("="))), opt(seq!(opt(deferred(WS)), deferred(TYPE_COMMENT)))),
...
fn compound_stmt() -> Combinator {
    tag("compound_stmt", choice!(
        seq!(lookahead(seq!(choice!(python_literal("def"), python_literal("@"), python_literal("async")), opt(deferred(WS)))), deferred(function_def)),
        seq!(lookahead(seq!(python_literal("if"), opt(deferred(WS)))), deferred(if_stmt)),
        seq!(lookahead(seq!(choice!(python_literal("class"), python_literal("@")), opt(deferred(WS)))), deferred(class_def)),
        seq!(lookahead(seq!(choice!(python_literal("with"), python_literal("async")), opt(deferred(WS)))), deferred(with_stmt)),
        seq!(lookahead(seq!(choice!(python_literal("for"), python_literal("async")), opt(deferred(WS)))), deferred(for_stmt)),
        seq!(lookahead(seq!(python_literal("try"), opt(deferred(WS)))), deferred(try_stmt)),
        seq!(lookahead(seq!(python_literal("while"), opt(deferred(WS)))), deferred(while_stmt)),
        deferred(match_stmt)
    )).into()
}
...
fn simple_stmt() -> Combinator {
    cached(tag("simple_stmt", choice!(
        deferred(assignment),
        seq!(lookahead(seq!(python_literal("type"), opt(deferred(WS)))), deferred(type_alias)),
        deferred(star_expressions),
        seq!(lookahead(seq!(python_literal("return"), opt(deferred(WS)))), deferred(return_stmt)),
        seq!(lookahead(seq!(choice!(python_literal("import"), python_literal("from")), opt(deferred(WS)))), deferred(import_stmt)),
        seq!(lookahead(seq!(python_literal("raise"), opt(deferred(WS)))), deferred(raise_stmt)),
        python_literal("pass"),
        seq!(lookahead(seq!(python_literal("del"), opt(deferred(WS)))), deferred(del_stmt)),
        seq!(lookahead(seq!(python_literal("yield"), opt(deferred(WS)))), deferred(yield_stmt)),
        seq!(lookahead(seq!(python_literal("assert"), opt(deferred(WS)))), deferred(assert_stmt)),
        python_literal("break"),
        python_literal("continue"),
        seq!(lookahead(seq!(python_literal("global"), opt(deferred(WS)))), deferred(global_stmt)),
        seq!(lookahead(seq!(python_literal("nonlocal"), opt(deferred(WS)))), deferred(nonlocal_stmt))
    ))).into()
}

fn simple_stmts() -> Combinator {
    tag("simple_stmts", seq!(deferred(simple_stmt), opt(deferred(WS)), choice!(seq!(negative_lookahead(seq!(python_literal(";"), opt(deferred(WS)))), deferred(NEWLINE)), seq!(opt(seq!(python_literal(";"), opt(deferred(WS)), deferred(simple_stmt), opt(repeat1(seq!(opt(deferred(WS)), python_literal(";"), opt(deferred(WS)), deferred(simple_stmt)))), opt(deferred(WS)))), opt(seq!(python_literal(";"), opt(deferred(WS)))), deferred(NEWLINE))))).into()
}
...
pub fn python_file() -> Combinator {
    ...
    cache_context(tag("main", seq!(opt(deferred(NEWLINE)), deferred(file)))).into()
}
