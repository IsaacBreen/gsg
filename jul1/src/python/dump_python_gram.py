...
def grammar_to_rust(
    ...
    f.write('use crate::{cache_context, cached, lookahead_context, symbol, Symbol, Choice, deferred, Combinator, CombinatorTrait, eat_char_choice, eat_char_range, eat_string, eps, Eps, forbid_follows, forbid_follows_check_not, forbid_follows_clear, forward_decls, forward_ref, Repeat1, Seq, tag, lookahead, negative_lookahead};\n')
