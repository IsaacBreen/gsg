...
pub fn whitespace() -> Combinator {
    repeat1(choice!(
            ...
            seq!(
                check_right_data(|right_data| right_data.borrow().scope_count > 0),
                breaking_space()
            ),
...
pub fn python_literal(s: &str) -> Combinator {
    let increment_scope_count = |right_data: &mut RightData| { right_data.borrow_mut().scope_count += 1; true };
    let decrement_scope_count = |right_data: &mut RightData| { right_data.borrow_mut().scope_count -= 1; true };
...
pub fn FSTRING_START() -> Combinator {
    ...
    let quote = choice!(
        seq!(eat_char('\''), mutate_right_data(|right_data| { right_data.borrow_mut().fstring_start_stack.push(PythonQuoteType::OneSingle); true })),
        seq!(eat_char('"'), mutate_right_data(|right_data| { right_data.borrow_mut().fstring_start_stack.push(PythonQuoteType::OneDouble); true })),
        seq!(eat_string("'''"), mutate_right_data(|right_data| { right_data.borrow_mut().fstring_start_stack.push(PythonQuoteType::ThreeSingle); true })),
        seq!(eat_string("\"\"\""), mutate_right_data(|right_data| { right_data.borrow_mut().fstring_start_stack.push(PythonQuoteType::ThreeDouble); true }))
    );
...
pub fn FSTRING_MIDDLE() -> Combinator {
    ...
    let quote = choice!(
        seq!(eat_char('\''), mutate_right_data(|right_data| { *right_data.borrow().fstring_start_stack.last().unwrap() != PythonQuoteType::OneSingle })),
        seq!(eat_char('"'), mutate_right_data(|right_data| { *right_data.borrow().fstring_start_stack.last().unwrap() != PythonQuoteType::OneDouble })),
    );
...
pub fn FSTRING_END() -> Combinator {
    let quote = choice!(
        seq!(eat_char('\''), mutate_right_data(|right_data| { right_data.borrow_mut().fstring_start_stack.pop().unwrap() == PythonQuoteType::OneSingle })),
        seq!(eat_char('"'), mutate_right_data(|right_data| { right_data.borrow_mut().fstring_start_stack.pop().unwrap() == PythonQuoteType::OneDouble })),
        seq!(eat_string("'''"), mutate_right_data(|right_data| { right_data.borrow_mut().fstring_start_stack.pop().unwrap() == PythonQuoteType::ThreeSingle })),
        seq!(eat_string("\"\"\""), mutate_right_data(|right_data| { right_data.borrow_mut().fstring_start_stack.pop().unwrap() == PythonQuoteType::ThreeDouble })),
    );
