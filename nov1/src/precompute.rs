...
mod tests {
    ...
    fn test_precompute() {
        ...
        state_1.insert(vec![Token { id: 0, width: 0 }], BTreeMap::from([(b"a".as_slice(), 1), (b"ab".as_slice(), 3)]));
        state_1.insert(vec![Token { id: 0, width: 0 }, Token { id: 0, width: 1 }], BTreeMap::from([(b"a".as_slice(), 0)]));
        state_1.insert(vec![Token { id: 0, width: 0 }, Token { id: 0, width: 1 }, Token { id: 1, width: 1 }], BTreeMap::from([(b"ab".as_slice(), 0)]));
        state_1.insert(vec![Token { id: 0, width: 0 }, Token { id: 1, width: 1 }], BTreeMap::from([(b"b".as_slice(), 0)]));
        state_1.insert(vec![Token { id: 0, width: 0 }, Token { id: 2, width: 2 }], BTreeMap::from([(b"ab".as_slice(), 0)]));
        state_1.insert(vec![Token { id: 0, width: 0 }, Token { id: 3, width: 3 }], BTreeMap::from([(b"abc".as_slice(), 0)]));
        ...
        state_2.insert(vec![Token { id: 1, width: 0 }], BTreeMap::from([(b"a".as_slice(), 1), (b"ab".as_slice(), 3)]));
        state_2.insert(vec![Token { id: 1, width: 0 }, Token { id: 0, width: 1 }], BTreeMap::from([(b"a".as_slice(), 0)]));
        state_2.insert(vec![Token { id: 1, width: 0 }, Token { id: 0, width: 1 }, Token { id: 1, width: 1 }], BTreeMap::from([(b"ab".as_slice(), 0)]));
        state_2.insert(vec![Token { id: 1, width: 0 }, Token { id: 1, width: 1 }], BTreeMap::from([(b"b".as_slice(), 0)]));
        state_2.insert(vec![Token { id: 1, width: 0 }, Token { id: 2, width: 2 }], BTreeMap::from([(b"ab".as_slice(), 0)]));
        state_2.insert(vec![Token { id: 1, width: 0 }, Token { id: 3, width: 3 }], BTreeMap::from([(b"abc".as_slice(), 0)]));

        let mut state_3: BTreeMap<Vec<Token>, BTreeMap<&[u8], StateID>> = BTreeMap::new();
        state_3.insert(vec![Token { id: 2, width: 0 }], BTreeMap::from([(b"a".as_slice(), 1), (b"ab".as_slice(), 3)]));
        state_3.insert(vec![Token { id: 2, width: 0 }, Token { id: 0, width: 1 }], BTreeMap::from([(b"a".as_slice(), 0)]));
        state_3.insert(vec![Token { id: 2, width: 0 }, Token { id: 0, width: 1 }, Token { id: 1, width: 1 }], BTreeMap::from([(b"ab".as_slice(), 0)]));
        state_3.insert(vec![Token { id: 2, width: 0 }, Token { id: 1, width: 1 }], BTreeMap::from([(b"b".as_slice(), 0)]));
        state_3.insert(vec![Token { id: 2, width: 0 }, Token { id: 2, width: 2 }], BTreeMap::from([(b"ab".as_slice(), 0)]));
        state_3.insert(vec![Token { id: 2, width: 0 }, Token { id: 3, width: 3 }], BTreeMap::from([(b"abc".as_slice(), 0)]));
        ...
        state_4.insert(vec![Token { id: 3, width: 0 }], BTreeMap::from([(b"a".as_slice(), 1), (b"ab".as_slice(), 3)]));
        state_4.insert(vec![Token { id: 3, width: 0 }, Token { id: 0, width: 1 }], BTreeMap::from([(b"a".as_slice(), 0)]));
        state_4.insert(vec![Token { id: 3, width: 0 }, Token { id: 0, width: 1 }, Token { id: 1, width: 1 }], BTreeMap::from([(b"ab".as_slice(), 0)]));
        state_4.insert(vec![Token { id: 3, width: 0 }, Token { id: 1, width: 1 }], BTreeMap::from([(b"b".as_slice(), 0)]));
        state_4.insert(vec![Token { id: 3, width: 0 }, Token { id: 2, width: 2 }], BTreeMap::from([(b"ab".as_slice(), 0)]));
        state_4.insert(vec![Token { id: 3, width: 0 }, Token { id: 3, width: 3 }], BTreeMap::from([(b"abc".as_slice(), 0)]));
